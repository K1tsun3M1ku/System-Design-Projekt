...
#define SENSOR_TYPE_LIGHT_ACTIVE                                               \
  IN_TYPE_LIGHT_ACTIVE /*!< NXT light sensor with light */
#define SENSOR_TYPE_LIGHT_INACTIVE                                             \
...
#define SENSOR_TYPE_LOWSPEED_9V                                                \
  IN_TYPE_LOWSPEED_9V /*!< NXT I2C digital sensor with 9V power */
#define SENSOR_TYPE_HIGHSPEED                                                  \
  IN_TYPE_HISPEED /*!< NXT Hi-speed port (only S4) */
#if __FIRMWARE_VERSION > 107
#define SENSOR_TYPE_COLORFULL                                                  \
  IN_TYPE_COLORFULL /*!< NXT 2.0 color sensor in full color mode */
#define SENSOR_TYPE_COLORRED                                                   \
  IN_TYPE_COLORRED /*!< NXT 2.0 color sensor with red light */
#define SENSOR_TYPE_COLORGREEN                                                 \
  IN_TYPE_COLORGREEN /*!< NXT 2.0 color sensor with green light */
#define SENSOR_TYPE_COLORBLUE                                                  \
  IN_TYPE_COLORBLUE /*!< NXT 2.0 color sensor with blue light */
#define SENSOR_TYPE_COLORNONE                                                  \
  IN_TYPE_COLORNONE /*!< NXT 2.0 color sensor with no light */
#endif
...
#define SENSOR_MODE_EDGE                                                       \
  IN_MODE_TRANSITIONCNT /*!< Counts the number of boolean transitions */
#define SENSOR_MODE_PULSE                                                      \
  IN_MODE_PERIODCOUNTER /*!< Counts the number of boolean periods */
#define SENSOR_MODE_PERCENT                                                    \
  IN_MODE_PCTFULLSCALE /*!< Scaled value from 0 to 100 */
#define SENSOR_MODE_CELSIUS                                                    \
  IN_MODE_CELSIUS /*!< RCX temperature sensor value in degrees celcius */
#define SENSOR_MODE_FAHRENHEIT                                                 \
  IN_MODE_FAHRENHEIT /*!< RCX temperature sensor value in degrees fahrenheit   \
                      */
#define SENSOR_MODE_ROTATION                                                   \
  IN_MODE_ANGLESTEP /*!< RCX rotation sensor (16 ticks per revolution) */
 ...
 * @{
 */
#define _SENSOR_CFG(_type, _mode)                                              \
  (((_type) << 8) + (_mode)) /*!< Macro for defining \ref SetSensor combined   \
                                type and mode constants */
#define SENSOR_TOUCH                                                           \
  _SENSOR_CFG(SENSOR_TYPE_TOUCH,                                               \
              SENSOR_MODE_BOOL) /*!< Touch sensor in boolean mode */
#define SENSOR_LIGHT                                                           \
  _SENSOR_CFG(SENSOR_TYPE_LIGHT,                                               \
              SENSOR_MODE_PERCENT) /*!< RCX Light sensor in percent mode */
#define SENSOR_ROTATION                                                        \
  _SENSOR_CFG(                                                                 \
      SENSOR_TYPE_ROTATION,                                                    \
      SENSOR_MODE_ROTATION) /*!< RCX rotation sensor in rotation mode */
#define SENSOR_CELSIUS                                                         \
  _SENSOR_CFG(                                                                 \
      SENSOR_TYPE_TEMPERATURE,                                                 \
      SENSOR_MODE_CELSIUS) /*!< RCX temperature sensor in celcius mode */
#define SENSOR_FAHRENHEIT                                                      \
  _SENSOR_CFG(SENSOR_TYPE_TEMPERATURE,                                         \
              SENSOR_MODE_FAHRENHEIT) /*!< RCX temperature sensor in           \
                                         fahrenheit mode */
#define SENSOR_PULSE                                                           \
  _SENSOR_CFG(SENSOR_TYPE_TOUCH,                                               \
              SENSOR_MODE_PULSE) /*!< Touch sensor in pulse mode */
#define SENSOR_EDGE                                                            \
  _SENSOR_CFG(SENSOR_TYPE_TOUCH,                                               \
              SENSOR_MODE_EDGE) /*!< Touch sensor in edge mode */
#define SENSOR_NXTLIGHT                                                        \
  _SENSOR_CFG(SENSOR_TYPE_LIGHT_ACTIVE,                                        \
              SENSOR_MODE_PERCENT) /*!< NXT light sensor in active mode */
#define SENSOR_SOUND                                                           \
  _SENSOR_CFG(                                                                 \
      SENSOR_TYPE_SOUND_DB,                                                    \
      SENSOR_MODE_PERCENT) /*!< NXT sound sensor (dB) in percent mode */
#define SENSOR_LOWSPEED_9V                                                     \
  _SENSOR_CFG(                                                                 \
      SENSOR_TYPE_LOWSPEED_9V,                                                 \
      SENSOR_MODE_RAW) /*!< NXT I2C sensor with 9V power in raw mode */
#define SENSOR_LOWSPEED                                                        \
  _SENSOR_CFG(                                                                 \
      SENSOR_TYPE_LOWSPEED,                                                    \
      SENSOR_MODE_RAW) /*!< NXT I2C sensor without 9V power in raw mode */
#if __FIRMWARE_VERSION > 107
#define SENSOR_COLORFULL                                                       \
  _SENSOR_CFG(SENSOR_TYPE_COLORFULL,                                           \
              SENSOR_MODE_RAW) /*!< NXT 2.0 color sensor (full) in raw mode */
#define SENSOR_COLORRED                                                        \
  _SENSOR_CFG(                                                                 \
      SENSOR_TYPE_COLORRED,                                                    \
      SENSOR_MODE_PERCENT) /*!< NXT 2.0 color sensor (red) in percent mode */
#define SENSOR_COLORGREEN                                                      \
  _SENSOR_CFG(SENSOR_TYPE_COLORGREEN,                                          \
              SENSOR_MODE_PERCENT) /*!< NXT 2.0 color sensor (green) in        \
                                      percent mode */
#define SENSOR_COLORBLUE                                                       \
  _SENSOR_CFG(                                                                 \
      SENSOR_TYPE_COLORBLUE,                                                   \
      SENSOR_MODE_PERCENT) /*!< NXT 2.0 color sensor (blue) in percent mode */
#define SENSOR_COLORNONE                                                       \
  _SENSOR_CFG(                                                                 \
      SENSOR_TYPE_COLORNONE,                                                   \
      SENSOR_MODE_PERCENT) /*!< NXT 2.0 color sensor (none) in percent mode */
#endif
/** @} */ // end of SensorModes group
 ...
 * This structure is used when calling the \ref SysColorSensorRead system call
 * function. Choose the sensor port (\ref InPorts) and after calling the
 * function read the sensor values from the ColorValue field or the raw,
 * normalized, or scaled value arrays.
...
struct ColorSensorReadType {
  ...
  byte Port; /*!< The sensor port. See the constants in the \ref InPorts group.
              */
  int ColorValue; /*!< The color value returned by the sensor. See the \ref
                     InputColorValueConstants group. */
  unsigned int RawArray[]; /*!< Raw color values returned by the sensor. See the
                              \ref InputColorIdxConstants group. */
  unsigned int
      NormalizedArray[]; /*!< Normalized color values returned by the sensor.
                            See the \ref InputColorIdxConstants group. */
  int ScaledArray[]; /*!< Scaled color values returned by the sensor. See the
                        \ref InputColorIdxConstants group. */
 ...
 * Read analog sensor values using these names.  Returns the current scaled
 * value of the sensor on the specified port.
 * @{
 */
#define SENSOR_1                                                               \
  Sensor(S1) /*!< Read the value of the analog sensor on port S1 */
#define SENSOR_2                                                               \
  Sensor(S2) /*!< Read the value of the analog sensor on port S2 */
#define SENSOR_3                                                               \
  Sensor(S3) /*!< Read the value of the analog sensor on port S3 */
#define SENSOR_4                                                               \
  Sensor(S4) /*!< Read the value of the analog sensor on port S4 */
 ...
 */
inline void SetSensorType(const byte &port, byte type) {
  asm { setin type, port, TypeField }
}
 ...
 */
inline void SetSensorMode(const byte &port, byte mode) {
  asm { setin mode, port, InputModeField }
}
 ...
 */
inline void ClearSensor(const byte &port) {
  asm { setin 0, port, ScaledValueField }
}
 ...
 */
inline void ResetSensor(const byte &port) {
  asm { __ResetSensor(port) }
}
 ...
 * \param port The port to configure. See \ref InPorts.
 */
inline void SetSensorTouch(const byte &port) {
  asm { __SetSensorTouch(port) }
}
...
inline void SetSensorLight(const byte &port, bool bActive = true) {
  SetSensorType(port, bActive ? SENSOR_TYPE_LIGHT_ACTIVE
...
inline void SetSensorSound(const byte &port, bool bdBScaling = true) {
  SetSensorType(port,
                bdBScaling ? SENSOR_TYPE_SOUND_DB : SENSOR_TYPE_SOUND_DBA);
  SetSensorMode(port, SENSOR_MODE_PERCENT);
  ResetSensor(port);
}
...
inline void SetSensorLowspeed(const byte &port, bool bIsPowered = true) {
  SetSensorType(port,
                bIsPowered ? SENSOR_TYPE_LOWSPEED_9V : SENSOR_TYPE_LOWSPEED);
 ...
 */
inline void SetSensorColorFull(const byte &port) {
  asm { __SetSensorColorFull(port) }
}
 ...
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
inline void SetSensorColorRed(const byte &port) {
  asm { __SetSensorColorRed(port) }
}
 ...
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
inline void SetSensorColorGreen(const byte &port) {
  asm { __SetSensorColorGreen(port) }
}
 ...
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
inline void SetSensorColorBlue(const byte &port) {
  asm { __SetSensorColorBlue(port) }
}
 ...
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
inline void SetSensorColorNone(const byte &port) {
  asm { __SetSensorColorNone(port) }
}
 ...
 *
 * \param args The ColorSensorReadType structure containing the required
 * parameters.
 *
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
 ...
 * This function lets you read the LEGO color sensor. It returns the color
 * value, and three arrays containing raw, normalized, and scaled color values
 * for red, green, blue, and none indices.
 *
 * \param port The sensor port. See \ref InPorts.
 * \param colorval The color value. See \ref InputColorValueConstants.
 * \param raw An array containing four raw color values. See \ref
 * InputColorIdxConstants.
 * \param norm An array containing four normalized color values. See \ref
 * InputColorIdxConstants.
 * \param scaled An array containing four scaled color values. See \ref
 * InputColorIdxConstants.
 * \return The function call result.
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
inline int ReadSensorColorEx(const byte &port, int &colorval,
                             unsigned int &raw[], unsigned int &norm[],
                             int &scaled[]);
 ...
 *
 * \param port The sensor port. See \ref InPorts.
 * \param rawVals An array containing four raw color values. See \ref
 * InputColorIdxConstants.
 * \return The function call result.
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
 ...
 * This function lets you directly access a specific LEGO color sensor AD raw
 * value. Both the port and the color index must be constants.
 *
 * \param port The sensor port. See \ref InPorts.
 ...
 * This function lets you directly access a specific LEGO color sensor boolean
 * value. Both the port and the color index must be constants.
 *
 * \param port The sensor port. See \ref InPorts.
 * \param color The color index. See \ref InputColorIdxConstants.
 ...
 * This function lets you directly access a specific LEGO color calibration
 * point value. The port, point, and color index must be constants.
 *
 * \param port The sensor port. See \ref InPorts.
 ...
 * This function lets you directly access a specific LEGO color calibration
 * limit value. The port and the point must be constants.
 *
 * \param port The sensor port. See \ref InPorts.
 * \param point The calibration point. See \ref InputColorCalibrationConstants.
 ...
 * This function lets you directly access a specific LEGO color sensor raw
 * value. Both the port and the color index must be constants.
 *
 * \param port The sensor port. See \ref InPorts.
 * \param color The color index. See \ref InputColorIdxConstants.
 ...
 * This function lets you directly access a specific LEGO color sensor scaled
 * value. Both the port and the color index must be constants.
 *
 * \param port The sensor port. See \ref InPorts.
 * \param color The color index. See \ref InputColorIdxConstants.
...
#define CustomSensorZeroOffset(_p)                                             \
  asm { GetInCustomZeroOffset(_p, __TMPWORD__) __RETURN__ __TMPWORD__ }
#define CustomSensorPercentFullScale(_p)                                       \
  asm { GetInCustomPercentFullScale(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define CustomSensorActiveStatus(_p)                                           \
  asm { GetInCustomActiveStatus(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define SensorBoolean(_p)                                                      \
  asm { GetInSensorBoolean(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define SensorDigiPinsDirection(_p)                                            \
  asm { GetInDigiPinsDirection(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define SensorDigiPinsStatus(_p)                                               \
  asm { GetInDigiPinsStatus(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define SensorDigiPinsOutputLevel(_p)                                          \
  asm { GetInDigiPinsOutputLevel(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }

#define SetCustomSensorZeroOffset(_p, _n) asm { __setInCustomZeroOffset(_p, _n) }
#define SetCustomSensorPercentFullScale(_p, _n)                                \
  asm { __setInCustomPercentFullScale(_p, _n) }
#define SetCustomSensorActiveStatus(_p, _n)                                    \
  asm { __setInCustomActiveStatus(_p, _n) }
#define SetSensorBoolean(_p, _n) asm { __setInSensorBoolean(_p, _n) }
#define SetSensorDigiPinsDirection(_p, _n)                                     \
  asm { __setInDigiPinsDirection(_p, _n) }
#define SetSensorDigiPinsStatus(_p, _n) asm { __setInDigiPinsStatus(_p, _n) }
#define SetSensorDigiPinsOutputLevel(_p, _n)                                   \
  asm { __setInDigiPinsOutputLevel(_p, _n) }

#if __FIRMWARE_VERSION > 107

#define SysColorSensorRead(_args)                                              \
  asm { \
  compchktype _args, ColorSensorReadType \
  syscall ColorSensorRead, _args }

#define ReadSensorColorRaw(_port, _rawVals)                                    \
  asm { __ReadSensorColorRaw(_port, _rawVals, __RETVAL__) }
#define ReadSensorColorEx(_port, _colorval, _raw, _norm, _scaled)              \
  asm { __ReadSensorColorEx(_port, _colorval, _raw, _norm, _scaled, __RETVAL__) }

#define ColorCalibration(_p, _np, _nc)                                         \
  asm { GetInColorCalibration(_p, _np, _nc, __TMPLONG__) __RETURN__ __TMPLONG__ }
#define ColorCalLimits(_p, _np)                                                \
  asm { GetInColorCalLimits(_p, _np, __TMPWORD__) __RETURN__ __TMPWORD__ }
#define ColorADRaw(_p, _nc)                                                    \
  asm { GetInColorADRaw(_p, _nc, __TMPWORD__) __RETURN__ __TMPWORD__ }
#define ColorSensorRaw(_p, _nc)                                                \
  asm { GetInColorSensorRaw(_p, _nc, __TMPWORD__) __RETURN__ __TMPWORD__ }
#define ColorSensorValue(_p, _nc)                                              \
  asm { GetInColorSensorValue(_p, _nc, __TMPWORD__) __RETURN__ __TMPWORD__ }
#define ColorBoolean(_p, _nc)                                                  \
  asm { GetInColorBoolean(_p, _nc, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define ColorCalibrationState(_p)                                              \
  asm { GetInColorCalibrationState(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
 ...
 * Choose the sensor port (\ref OutputPortConstants) and after calling the
 * function read the output status values from the various structure fields.
 */
struct OutputStateType {
  ...
  byte RegMode; /*!< The output regulation mode. See \ref OutRegModeConstants
                   group. */
 ...
 * store the output port values in the byte array before passing it into this
 * function.
 ...
 * algorithm. See \ref PIDConstants.
 */
inline void OnFwdSyncPID(byte outputs, char pwr, char turnpct, byte p, byte i,
                         byte d);
 ...
 * algorithm. See \ref PIDConstants.
 */
inline void OnFwdSyncExPID(byte outputs, char pwr, char turnpct,
                           const byte reset, byte p, byte i, byte d);
 ...
 * algorithm. See \ref PIDConstants.
 */
inline void OnRevSyncPID(byte outputs, char pwr, char turnpct, byte p, byte i,
                         byte d);
 ...
 * algorithm. See \ref PIDConstants.
 */
inline void OnRevSyncExPID(byte outputs, char pwr, char turnpct,
                           const byte reset, byte p, byte i, byte d);
 ...
 * algorithm. See \ref PIDConstants.
 */
inline void OnFwdRegPID(byte outputs, char pwr, byte regmode, byte p, byte i,
                        byte d);
 ...
 * algorithm. See \ref PIDConstants.
 */
inline void OnFwdRegExPID(byte outputs, char pwr, byte regmode,
                          const byte reset, byte p, byte i, byte d);
 ...
 * algorithm. See \ref PIDConstants.
 */
inline void OnRevRegPID(byte outputs, char pwr, byte regmode, byte p, byte i,
                        byte d);
 ...
 * algorithm. See \ref PIDConstants.
 */
inline void OnRevRegExPID(byte outputs, char pwr, byte regmode,
                          const byte reset, byte p, byte i, byte d);
 ...
 * algorithm. See \ref PIDConstants.
 */
inline void RotateMotorPID(byte outputs, char pwr, long angle, byte p, byte i,
                           byte d);
 ...
 * rotation.
 */
inline void RotateMotorEx(byte outputs, char pwr, long angle, char turnpct,
                          bool sync, bool stop);
 ...
 * algorithm. See \ref PIDConstants.
 */
inline void RotateMotorExPID(byte outputs, char pwr, long angle, char turnpct,
                             bool sync, bool stop, byte p, byte i, byte d);
 ...
 * you need to add single output port values into a byte array and pass the
 * array instead of a single numeric value.
 */
 ...
 * you need to add single output port values into a byte array and pass the
 * array instead of a single numeric value.
 * \param field1 The 1st output port field to access, this should be a constant,
 * see
 * \ref OutputFieldConstants.
 * \param val1 Value to set for the 1st field.
 * \param fieldN The Nth output port field to access, this should be a constant,
 * see
 * \ref OutputFieldConstants.
 * \param valN The value to set for the Nth field.
 */
inline void SetOutput(byte outputs, byte field1, variant val1, ..., byte fieldN,
                      variant valN);
...
#define MotorRegulationTime()                                                  \
  asm { GetOutRegulationTime(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
...
#define MotorRegulationOptions()                                               \
  asm { GetOutRegulationOptions(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
 ...
 * This structure is used when calling the \ref SysDrawText system call
 * function. It lets you specify the text to draw, the LCD line and horizontal
 * position using the
 ...
 * \ref LocationType structure member, the radius, as well as drawing options
 * defined in the \ref DisplayDrawOptionConstants group.
 * \sa SysDrawCircle()
 */
 ...
 * function.
 * It lets you specify the corner of the rectangle using the \ref LocationType
 * structure member, the width and height of the rectangle using the \ref
 * SizeType structure member, as well as drawing options defined in the \ref
 * DisplayDrawOptionConstants group.
 * \sa SysDrawRect()
 */
struct DrawRectType {
  char Result; /*!< The function call result. \ref NO_ERR means it succeeded. */
...
struct SetScreenModeType {
  ...
  unsigned long
      ScreenMode; /*!< The requested screen mode.
...
struct DrawGraphicArrayType {
  ...
  long Variables[];      /*!< The variables passed as RIC arguments. */
  unsigned long Options; /*!< The options to use when writing to the LCD. \ref
...
struct DrawPolygonType {
  char Result; /*!< The function call result. \ref NO_ERR means it succeeded. */
  LocationType Points[]; /*!< An array of LocationType structures which define
                            the polygon's shape. */
  unsigned long Options; /*!< The options to use when writing to the LCD. \ref
                            DisplayDrawOptionConstants */
};
 ...
 * as well as drawing options defined in the \ref DisplayDrawOptionConstants
 * group.
 * \sa SysDrawEllipse()
 */
 ...
 * This structure is used when calling the \ref SysDrawFont system call
 * function. It lets you specify the text to draw, the LCD line and horizontal
 * position using the
 * \ref LocationType structure member, as well as drawing options defined
 * in the \ref DisplayDrawOptionConstants group.
 ...
 * drawing options. If this argument is not specified it defaults to \ref
 * DRAW_OPT_NORMAL. Valid display option constants are listed in the \ref
 * DisplayDrawOptionConstants group.
 ...
 */
inline char CircleOut(int x, int y, byte radius,
 ...
 * defaults to \ref DRAW_OPT_NORMAL. Valid display option constants are listed
 * in the \ref DisplayDrawOptionConstants group.
 ...
 * \return The result of the drawing operation.
 */
inline char LineOut(int x1, int y1, int x2, int y2,
                    unsigned long options = DRAW_OPT_NORMAL);
 ...
 * \return The result of the drawing operation.
 */
inline char RectOut(int x, int y, int width, int height,
                    unsigned long options = DRAW_OPT_NORMAL);
 ...
 * \return The result of the drawing operation.
 */
inline char TextOut(int x, int y, string str,
                    unsigned long options = DRAW_OPT_NORMAL);
 ...
 * \param value The value to output to the LCD screen. Any numeric type is
 * supported.
 * \param options The optional drawing options.
 * \return The result of the drawing operation.
 */
inline char NumOut(int x, int y, variant value,
                   unsigned long options = DRAW_OPT_NORMAL);
 ...
 * \return The result of the drawing operation.
 */
inline char EllipseOut(int x, int y, byte radiusX, byte radiusY,
                       unsigned long options = DRAW_OPT_NORMAL);
 ...
 * \return The result of the drawing operation.
 */
inline char PolyOut(LocationType points[],
                    unsigned long options = DRAW_OPT_NORMAL);
 ...
 * \return The result of the drawing operation.
 */
inline char FontTextOut(int x, int y, string filename, string str,
                        unsigned long options = DRAW_OPT_NORMAL);
 ...
 * \return The result of the drawing operation.
 */
inline char FontNumOut(int x, int y, string filename, variant value,
                       unsigned long options = DRAW_OPT_NORMAL);
 ...
 * Optionally specify drawing options. If this argument is not specified it
 * defaults to \ref DRAW_OPT_NORMAL. Valid display option constants are listed
 * in the \ref DisplayDrawOptionConstants group. If the file cannot be found
 * then nothing will be drawn and no errors will be reported.
 ...
 * \return The result of the drawing operation.
 */
inline char GraphicOut(int x, int y, string filename,
                       unsigned long options = DRAW_OPT_NORMAL);

/**
 * Draw a graphic image from byte array.
 * Draw a graphic image byte array on the screen at the specified x and y
 * location. Optionally specify drawing options. If this argument is not
 * specified it defaults to \ref DRAW_OPT_NORMAL. Valid display option constants
 * are listed in the \ref DisplayDrawOptionConstants group. If the file cannot
 ...
 * \return The result of the drawing operation.
 */
inline char GraphicArrayOut(int x, int y, byte data[],
                            unsigned long options = DRAW_OPT_NORMAL);

/**
 * Draw a graphic image with parameters.
 * Draw a graphic image file on the screen at the specified x and y location
 * using an array of parameters. Optionally specify drawing options. If this
 * argument is not specified it defaults to \ref DRAW_OPT_NORMAL. Valid display
 * option constants are listed in the \ref DisplayDrawOptionConstants group. If
 * the file cannot be found then nothing will be drawn and no errors will be
 * reported.
 * \sa SysDrawGraphic, DrawGraphicType
 *
 * \param x The x value for the position of the graphic image.
 ...
 * \return The result of the drawing operation.
 */
inline char GraphicOutEx(int x, int y, string filename, byte vars[],
                         unsigned long options = DRAW_OPT_NORMAL);

/**
 * Draw a graphic image from byte array with parameters.
 * Draw a graphic image byte array on the screen at the specified x and y
 * location using an array of parameters. Optionally specify drawing options. If
 * this argument is not specified it defaults to \ref DRAW_OPT_NORMAL. Valid
 * display option constants are listed in the \ref DisplayDrawOptionConstants
 * group. If the file cannot be found then nothing will be drawn and no errors
 * will be reported.
 * \sa SysDrawGraphicArray, DrawGraphicArrayType
 *
 * \param x The x value for the position of the graphic image.
 ...
 * \return The result of the drawing operation.
 */
inline char GraphicArrayOutEx(int x, int y, byte data[], byte vars[],
                              unsigned long options = DRAW_OPT_NORMAL);
 ...
 */
inline void GetDisplayNormal(const byte x, const byte line, unsigned int cnt,
                             byte &data[]);
 ...
 */
inline void SetDisplayNormal(const byte x, const byte line, unsigned int cnt,
                             byte data[]);
 ...
 * \param data The array of bytes into which pixel data is read.
 */
inline void GetDisplayPopup(const byte x, const byte line, unsigned int cnt,
                            byte &data[]);
 ...
 * \param data The array of bytes from which pixel data is read.
 */
inline void SetDisplayPopup(const byte x, const byte line, unsigned int cnt,
                            byte data[]);
...
/**
 * Draw a circle.
 * This function lets you draw a circle on the NXT LCD given the parameters you
 * pass in via the \ref DrawCircleType structure.
 *
 ...
 *
 * \param args The SetScreenModeType structure containing the screen mode
 * parameters.
 */
 ...
 *
 * \param args The DisplayExecuteFunctionType structure containing the drawing
 * parameters.
 */
 ...
 * This function lets you draw a graphic image on the NXT LCD given the
 * parameters you pass in via the \ref DrawGraphicArrayType structure.
 *
 * \param args The DrawGraphicArrayType structure containing the drawing
 * parameters.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 */
...
/**
 * Draw a polygon.
 * This function lets you draw a polygon on the NXT LCD given the parameters you
 * pass in via the \ref DrawPolygonType structure.
 *
...
/**
 * Draw an ellipse.
 * This function lets you draw an ellipse on the NXT LCD given the parameters
 * you pass in via the \ref DrawEllipseType structure.
 *
...
#define GetDisplayNormal(_x, _line, _cnt, _data)                               \
  asm { __getDisplayNormal(_x, _line, _cnt, _data) }
#define GetDisplayPopup(_x, _line, _cnt, _data)                                \
  asm { __getDisplayPopup(_x, _line, _cnt, _data) }

#define DisplayEraseMask()                                                     \
  asm { GetDisplayEraseMask(__TMPLONG__) __RETURN__ __TMPLONG__ }
#define DisplayUpdateMask()                                                    \
  asm { GetDisplayUpdateMask(__TMPLONG__) __RETURN__ __TMPLONG__ }
#define DisplayFont() asm { GetDisplayFont(__TMPLONG__) __RETURN__ __TMPLONG__ }
#define DisplayDisplay()                                                       \
  asm { GetDisplayDisplay(__TMPLONG__) __RETURN__ __TMPLONG__ }
#define DisplayFlags() asm { GetDisplayFlags(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define DisplayTextLinesCenterFlags()                                          \
  asm { GetDisplayTextLinesCenterFlags(__TMPBYTE__) __RETURN__ __TMPBYTE__ }

#define SetDisplayNormal(_x, _line, _cnt, _data)                               \
  asm { __setDisplayNormal(_x, _line, _cnt, _data) }
#define SetDisplayPopup(_x, _line, _cnt, _data)                                \
  asm { __setDisplayPopup(_x, _line, _cnt, _data) }

#define SysDrawText(_args)                                                     \
  asm { \
  compchktype _args, DrawTextType \
  syscall DrawText, _args }
#define SysDrawPoint(_args)                                                    \
  asm { \
  compchktype _args, DrawPointType \
  syscall DrawPoint, _args }
#define SysDrawLine(_args)                                                     \
  asm { \
  compchktype _args, DrawLineType \
  syscall DrawLine, _args }
#define SysDrawCircle(_args)                                                   \
  asm { \
  compchktype _args, DrawCircleType \
  syscall DrawCircle, _args }
#define SysDrawRect(_args)                                                     \
  asm { \
  compchktype _args, DrawRectType \
  syscall DrawRect, _args }
#define SysDrawGraphic(_args)                                                  \
  asm { \
  compchktype _args, DrawGraphicType \
  syscall DrawGraphic, _args }
#define SysSetScreenMode(_args)                                                \
  asm { \
...
#define SysDisplayExecuteFunction(_args)                                       \
  asm { \
 ...
 */
inline void ClearLine(byte line) {
  asm { TextOutEx(0, line, __BlankLine, 0) }
}
 ...
 */
inline void SetDisplayFont(unsigned long fontaddr) {
  asm { __setDisplayFont(fontaddr) }
}
 ...
 */
inline void SetDisplayDisplay(unsigned long dispaddr) {
  asm { __setDisplayDisplay(dispaddr) }
}
...
inline void SetDisplayEraseMask(unsigned long eraseMask) {
  asm { __setDisplayEraseMask(eraseMask) }
}
...
inline void SetDisplayTextLinesCenterFlags(byte ctrFlags) {
  asm { __setDisplayTextLinesCenterFlags(ctrFlags) }
}
 ...
 */
inline void SetDisplayUpdateMask(unsigned long updateMask) {
  asm { __setDisplayUpdateMask(updateMask) }
}
 ...
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 */
inline void SetDisplayContrast(byte contrast) {
  asm { __setDisplayContrast(contrast) }
}
...
struct Tone {
  unsigned int
      Frequency; /*!< The tone frequency. See the \ref ToneConstants group. */
  unsigned int Duration; /*!< The tone duration in milliseconds. See the \ref
                            TimeConstants group. */
};
...
struct SoundGetStateType {
  byte State; /*!< The returned sound state. See the \ref SoundStateConstants
                 group. */
  byte Flags; /*!< The returned sound flags. See the \ref SoundFlagsConstants
                 group. */
};
 ...
 */
inline char PlayToneEx(unsigned int frequency, unsigned int duration,
                       byte volume, bool loop);

/**
 * Get sound module state.
 * Return the current sound module state. See the \ref SoundStateConstants
 * group.
 *
 ...
 * Return the current sound module flags. See the \ref SoundFlagsConstants
 * group.
 *
...
#define SoundFrequency()                                                       \
  asm { GetSoundFrequency(__TMPWORD__) __RETURN__ __TMPWORD__ }
#define SoundDuration()                                                        \
  asm { GetSoundDuration(__TMPWORD__) __RETURN__ __TMPWORD__ }
#define SoundSampleRate()                                                      \
  asm { GetSoundSampleRate(__TMPWORD__) __RETURN__ __TMPWORD__ }
...
struct CommLSWriteType {
  ...
  byte Buffer[];  /*!< The buffer containing data to be written to the I2C
                     device. */
  byte ReturnLen; /*!< The number of bytes that you want to read from the I2C
                    device after writing the data.  If no read is planned set
                    this to zero. */
};
...
struct CommLSReadType {
  ...
  byte Port;      /*!< The port to which the I2C device is connected. */
  byte Buffer[];  /*!< The buffer used to store the bytes read from the I2C
                     device. */
...
struct CommLSCheckStatusType {
  char Result;     /*!< The function call result. Possible values include
                     ...
                     and \ref NO_ERR. */
  byte Port;       /*!< The port to which the I2C device is connected. */
  byte BytesReady; /*!< The number of bytes ready to read from the specified
                      port. */
};
...
struct CommLSWriteExType {
  ...
  byte ReturnLen; /*!< The number of bytes that you want to read from the I2C
                     device. */
  bool NoRestartOnRead; /*!< Should a restart occur before reading from the
                           device? */
};
#endif
 ...
 * \return A status code indicating whether the read completed successfully or
 * not. See \ref CommLSReadType for possible result values.
 */
 ...
 * not. See \ref CommLSReadType for possible result values.
 */
inline char ReadSensorEMeter(const byte &port, float &vIn, float &aIn,
                             float &vOut, float &aOut, int &joules, float &wIn,
                             float &wOut);
 ...
 * \param bytesready The number of bytes available to be read from the internal
 * I2C buffer. The maximum number of bytes that can be read is 16.
 * \return A status code indicating whether the write completed successfully or
 * not. See \ref CommLSCheckStatusType for possible result values. If the return
 * value is \ref NO_ERR then the last operation did not cause any errors.
 * Avoid calls to \ref LowspeedRead or \ref LowspeedWrite while LowspeedStatus
 * returns
 * \ref STAT_COMM_PENDING.
 * \sa I2CStatus, I2CRead, I2CWrite, I2CCheckStatus, I2CBytesReady,
 ...
 * not. See \ref CommLSCheckStatusType for possible result values. If the return
 * value is \ref NO_ERR then the last operation did not cause any errors.
 * Avoid calls to \ref LowspeedRead or \ref LowspeedWrite while
 * LowspeedCheckStatus returns
 * \ref STAT_COMM_PENDING.
 * \sa I2CCheckStatus, I2CRead, I2CWrite, I2CStatus, I2CBytesReady,
 ...
 * be used where possible to avoid blocking access to I2C devices on other
 * ports by code running on other threads.
 * \return The number of bytes available to be read from the internal I2C
 * buffer. The maximum number of bytes that can be read is 16.
 * \sa I2CCheckStatus, I2CRead, I2CWrite, I2CStatus, I2CBytesReady,
 * LowspeedRead, LowspeedWrite, and LowspeedStatus
 */
 ...
 * \return A status code indicating whether the write completed successfully or
 * not. See \ref CommLSWriteType for possible result values. If the return value
 * is \ref NO_ERR then the last operation did not cause any errors.
 * \sa I2CCheckStatus, I2CRead, I2CWrite, I2CStatus, I2CBytesReady,
 ...
 * buffer.  If the return value is negative then the output buffer will be
 * empty.
 * \return A status code indicating whether the write completed successfully or
 * not. See \ref CommLSReadType for possible result values. If the return value
 * is \ref NO_ERR then the last operation did not cause any errors.
 * \sa I2CCheckStatus, I2CRead, I2CWrite, I2CStatus, I2CBytesReady,
 ...
 * I2C buffer. The maximum number of bytes that can be read is 16.
 * \return A status code indicating whether the write completed successfully or
 * not. See \ref CommLSCheckStatusType for possible return values. If the return
 * value is \ref NO_ERR then the last operation did not cause any errors.
 ...
 * \return The number of bytes available to be read from the internal I2C
 * buffer. The maximum number of bytes that can be read is 16.
 * \sa I2CCheckStatus, I2CRead, I2CWrite, I2CStatus, LowspeedBytesReady,
 * LowspeedRead, LowspeedWrite, and LowspeedStatus
 */
 ...
 * not. See \ref CommLSWriteType for possible result values. If the return value
 * is \ref NO_ERR then the last operation did not cause any errors.
 * \sa I2CCheckStatus, I2CRead, I2CStatus, I2CBytesReady, LowspeedRead,
 * LowspeedWrite, LowspeedCheckStatus, LowspeedBytesReady, and LowspeedStatus
 */
 ...
 * not. See \ref CommLSReadType for possible result values. If the return value
 * is \ref NO_ERR then the last operation did not cause any errors.
 * \sa I2CCheckStatus, I2CWrite, I2CStatus, I2CBytesReady, LowspeedRead,
 * LowspeedWrite, LowspeedCheckStatus, LowspeedBytesReady, and LowspeedStatus
 */
 ...
 * succeeded or failed.
 * \sa I2CCheckStatus, I2CWrite, I2CStatus, I2CBytesReady, I2CRead,
 * LowspeedRead, LowspeedWrite, LowspeedCheckStatus, LowspeedBytesReady, and
 * LowspeedStatus
 */
inline long I2CBytes(const byte port, byte inbuf[], byte &count,
                     byte &outbuf[]);
 ...
 * \return A status code indicating whether the write completed successfully or
 * not. See \ref CommLSCheckStatusType for possible result values.
 */
 ...
 * ports by code running on other threads.
 * \param i2caddr The I2C device address.
 * \param info A value indicating the type of device information you are
 * requesting. See \ref GenericI2CConstants.
 ...
 * Read standard I2C device identifier. The I2C device uses the specified
 * address.
 *
 * \param port The port to which the I2C device is attached. See the
 * \ref InPorts group. You may use a constant or a variable. Constants should
...
/**
 * Send an I2C command.
 * Send a command to an I2C device at the standard command register: \ref
 * I2C_REG_CMD. The I2C device uses the specified address.
 * \param port The port to which the I2C device is attached. See the
 * \ref InPorts group. You may use a constant or a variable. Constants should
 * be used where possible to avoid blocking access to I2C devices on other
 * ports by code running on other threads.
...
/** @defgroup LowLevelLowSpeedModuleFunctions Low level LowSpeed module
 * functions Low level functions for accessing low speed module features.
 * @{
 */
 ...
 */
inline void GetLSInputBuffer(const byte port, const byte offset, byte cnt,
                             byte &data[]);
 ...
 */
inline void GetLSOutputBuffer(const byte port, const byte offset, byte cnt,
                              byte &data[]);
 ...
 * This method returns the value of the I2C channel state for the specified
 * port.
 * \param port A constant port number (S1..S4). See \ref InPorts.
 ...
 * \return The I2C no restart on read field. See \ref
...
inline void SetLSInputBuffer(const byte port, const byte offset, byte cnt, byte
data[]); inline void SetLSInputBufferInPtr(const byte port, byte n); inline void
SetLSInputBufferOutPtr(const byte port, byte n); inline void
SetLSInputBufferBytesToRx(const byte port, byte n); inline void
SetLSOutputBuffer(const byte port, const byte offset, byte cnt, byte data[]);
...
/** @defgroup LowSpeedModuleSystemCallFunctions LowSpeed module system call
 * functions System call functions for accessing low speed module features.
 * @{
 */
 ...
 *
 * \param args The CommLSWriteExType structure containing the desired
 * parameters.
 */
...
#define ReadSensorUSEx(_port, _values)                                         \
  asm { __ReadSensorUSEx(_port, _values, __RETVAL__) }

#define ReadSensorEMeter(_port, _vIn, _aIn, _vOut, _aOut, _joules, _wIn,       \
                         _wOut)                                                \
  asm { __ReadSensorEMeter(_port, _vIn, _aIn, _vOut, _aOut, _joules, _wIn, _wOut, __RETVAL__) }

#define ConfigureTemperatureSensor(_port, _config)                             \
  asm { __TempSendCmd(_port, _config, __RETVAL__) }
#if __FIRMWARE_VERSION > 107
#define SensorTemperature(_port)                                               \
  asm { __ReadSensorTemperature(_port, __FLTRETVAL__) }
#else
#define SensorTemperature(_port)                                               \
  asm { __ReadSensorTemperature(_port, __RETVAL__) }
#endif

#define ReadI2CRegister(_port, _i2caddr, _reg, _out)                           \
  asm { __MSReadValue(_port, _i2caddr, _reg, 1, _out, __RETVAL__) }
#define WriteI2CRegister(_port, _i2caddr, _reg, _val)                          \
  asm { __MSWriteToRegister(_port, _i2caddr, _reg, _val, __RETVAL__) }

#define LowspeedStatus(_port, _bready)                                         \
  asm { __lowspeedStatus(_port, _bready, __RETVAL__) }
#define LowspeedCheckStatus(_port)                                             \
  asm { __lowspeedStatus(_port, __TMPBYTE__, __RETVAL__) }
#define LowspeedBytesReady(_port)                                              \
  asm { __lowspeedStatus(_port, __RETVAL__, __TMPBYTE__) }
#define LowspeedWrite(_port, _retlen, _buffer)                                 \
  asm { __lowspeedWrite(_port, _retlen, _buffer, __RETVAL__) }
#define LowspeedRead(_port, _buflen, _buffer)                                  \
  asm { __lowspeedRead(_port, _buflen, _buffer, __RETVAL__) }
...
#define I2CBytes(_port, _inbuf, _count, _outbuf)                               \
  asm { ReadI2CBytes(_port, _inbuf, _count, _outbuf, __RETVAL__) }

#define I2CDeviceInfo(_port, _i2caddr, _info)                                  \
  asm { ReadI2CDeviceInfo(_port, _i2caddr, _info, __STRRETVAL__) }
#define I2CVersion(_port, _i2caddr)                                            \
  asm { ReadI2CDeviceInfo(_port, _i2caddr, I2C_REG_VERSION, __STRRETVAL__) }
#define I2CVendorId(_port, _i2caddr)                                           \
  asm { ReadI2CDeviceInfo(_port, _i2caddr, I2C_REG_VENDOR_ID, __STRRETVAL__) }
#define I2CDeviceId(_port, _i2caddr)                                           \
  asm { ReadI2CDeviceInfo(_port, _i2caddr, I2C_REG_DEVICE_ID, __STRRETVAL__) }

#define I2CSendCommand(_port, _i2caddr, _cmd)                                  \
  asm { __I2CSendCmd(_port, _i2caddr, _cmd, __RETVAL__) }

#define GetLSInputBuffer(_p, _offset, _cnt, _data)                             \
  asm { __getLSInputBuffer(_p, _offset, _cnt, _data) }
#define GetLSOutputBuffer(_p, _offset, _cnt, _data)                            \
  asm { __getLSOutputBuffer(_p, _offset, _cnt, _data) }

#define LSInputBufferInPtr(_p)                                                 \
  asm { GetLSInputBufferInPtr(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define LSInputBufferOutPtr(_p)                                                \
  asm { GetLSInputBufferOutPtr(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define LSInputBufferBytesToRx(_p)                                             \
  asm { GetLSInputBufferBytesToRx(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define LSOutputBufferInPtr(_p)                                                \
  asm { GetLSOutputBufferInPtr(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define LSOutputBufferOutPtr(_p)                                               \
  asm { GetLSOutputBufferOutPtr(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define LSOutputBufferBytesToRx(_p)                                            \
  asm { GetLSOutputBufferBytesToRx(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define LSMode(_p) asm { GetLSMode(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define LSChannelState(_p)                                                     \
  asm { GetLSChannelState(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define LSErrorType(_p)                                                        \
  asm { GetLSErrorType(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
...
#ifdef __ENHANCED_FIRMWARE
#define LSNoRestartOnRead(_n)                                                  \
  asm { GetLSNoRestartOnRead(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#endif

#define SetLSInputBuffer(_p, _offset, _cnt, _data)                             \
  asm { __setLSInputBuffer(_p, _offset, _cnt, _data) }
...
#define SetLSInputBufferBytesToRx(_p, _n)                                      \
  asm { __setLSInputBufferBytesToRx(_p, _n) }

#define SetLSOutputBuffer(_p, _offset, _cnt, _data)                            \
  asm { __setLSOutputBuffer(_p, _offset, _cnt, _data) }
...
#define SetLSOutputBufferBytesToRx(_p, _n)                                     \
  asm { __setLSOutputBufferBytesToRx(_p, _n) }
...
struct IOMapReadType {
  char Result; /*!< The function call result. \ref NO_ERR means it succeeded. */
  string ModuleName; /*!< The name of the module to read from. See the \ref
                        ModuleNameConstants group. */
  unsigned int
      Offset; /*!< The offset in the module IOMap where to start reading. */
...
struct IOMapWriteType {
  char Result; /*!< The function call result. \ref NO_ERR means it succeeded. */
  string ModuleName; /*!< The name of the module to write to. See the \ref
                        ModuleNameConstants group. */
  unsigned int
      Offset;    /*!< The offset in the module IOMap where to start writing. */
...
struct IOMapReadByIDType {
  char Result; /*!< The function call result. \ref NO_ERR means it succeeded. */
  unsigned long ModuleID; /*!< The identifier of the module to read from. See
                             the \ref ModuleIDConstants group. */
  unsigned int
      Offset; /*!< The offset in the module IOMap where to start reading. */
  unsigned int Count; /*!< The number of bytes to read. */
  byte Buffer[];      /*!< The buffer used to store read bytes. */
...
struct IOMapWriteByIDType {
  char Result; /*!< The function call result. \ref NO_ERR means it succeeded. */
  unsigned long ModuleID; /*!< The identifier of the module to write to. See the
                             \ref ModuleIDConstants group. */
  unsigned int
      Offset;    /*!< The offset in the module IOMap where to start writing. */
  byte Buffer[]; /*!< The buffer containing bytes to write. */
};
 ...
 * This structure is used when calling the \ref SysUpdateCalibCacheInfo system
 * call function.
 ...
 *
 * \todo figure out what this function is intended for
 * \param args The DatalogGetTimesType structure containing the needed
 * parameters.
 *
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
 ...
 *
 * \todo figure out what this function is intended for
 * \param args The UpdateCalibCacheInfoType structure containing the needed
 * parameters.
 *
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
 ...
 *
 * \todo figure out what this function is intended for
 * \param args The ComputeCalibValueType structure containing the needed
 * parameters.
 *
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
 ...
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 *
 * \param Compact A boolean value indicating whether to compact the dataspace or
 * not.
 ...
 * operation.
 */
inline char GetMemoryInfo(bool Compact, unsigned int &PoolSize,
 ...
 *
 * \param args The MemoryManagerType structure containing the required
 * parameters.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 */
 ...
 */
inline char GetLastResponseInfo(bool Clear, byte &Length, byte &Command,
                                byte &Buffer[]);
 ...
 *
 * \param args The ReadLastResponseType structure containing the required
 * parameters.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.31+.
 */
...
#define ResetSleepTimer()                                                      \
  asm { acquire __KeepAliveMutex \
...
#define GetMemoryInfo(_Compact, _PoolSize, _DataspaceSize)                     \
  asm { __GetMemoryInfo(_Compact,_PoolSize,_DataspaceSize,__RETVAL__) }

#define SysMemoryManager(_args)                                                \
  asm { \
  compchktype _args, MemoryManagerType \
  syscall MemoryManager, _args }

#define GetLastResponseInfo(_Clear, _Length, _Command, _Buffer)                \
  asm { __GetLastResponseInfo(_Clear,_Length,_Command,_Buffer,__RETVAL__) }

#define SysReadLastResponse(_args)                                             \
  asm { \
 ...
 */
inline void ArrayBuild(variant &aout[], variant src1, variant src2, ...,
                       variant srcN);
 ...
 */
inline void ArraySubset(variant &aout[], variant asrc[], unsigned int idx,
                        unsigned int len);
 ...
 * \return The sum of len elements from the src numeric array (starting from
 * idx).
 */
inline variant ArraySum(const variant &src[], unsigned int idx,
                        unsigned int len);
 ...
 * \ref NA to include the rest of the elements in the src array (from idx to
 * the end of the array).
 * \return The mean value of len elements from the src numeric array (starting
 * from idx).
 */
inline variant ArrayMean(const variant &src[], unsigned int idx,
                         unsigned int len);

/**
 * Calculate the sum of the squares of the elements in a numeric array.
 * This function calculates the sum of the squares of all or a subset of the
 * elements in the numeric src array.
 *
 * \warning This function requires the enhanced NBC/NXC firmware.
 *
 * \param src The source numeric array.
 ...
 * \ref NA to include the rest of the elements in the src array (from idx to
 * the end of the array).
 * \return The sum of the squares of len elements from the src numeric array
 * (starting from idx).
 */
inline variant ArraySumSqr(const variant &src[], unsigned int idx,
                           unsigned int len);

/**
 * Calculate the standard deviation of the elements in a numeric array.
 * This function calculates the standard deviation of all or a subset of the
 * elements in the numeric src array.
 *
 * \warning This function requires the enhanced NBC/NXC firmware.
 *
 ...
 * \ref NA to include the rest of the elements in the src array (from idx to
 * the end of the array).
 * \return The standard deviation of len elements from the src numeric array
 * (starting from idx).
 */
inline variant ArrayStd(const variant &src[], unsigned int idx,
                        unsigned int len);

/**
 * Calculate the minimum of the elements in a numeric array.
 * This function calculates the minimum of all or a subset of the elements in
 * the numeric src array.
 *
 * \warning This function requires the enhanced NBC/NXC firmware.
 *
 * \param src The source numeric array.
 ...
 * \ref NA to include the rest of the elements in the src array (from idx to
 * the end of the array).
 * \return The minimum of len elements from the src numeric array (starting from
 * idx).
 */
inline variant ArrayMin(const variant &src[], unsigned int idx,
                        unsigned int len);

/**
 * Calculate the maximum of the elements in a numeric array.
 * This function calculates the maximum of all or a subset of the elements in
 * the numeric src array.
 *
 * \warning This function requires the enhanced NBC/NXC firmware.
 *
 ...
 * \ref NA to include the rest of the elements in the src array (from idx to
 * the end of the array).
 * \return The maximum of len elements from the src numeric array (starting from
 * idx).
 */
inline variant ArrayMax(const variant &src[], unsigned int idx,
                        unsigned int len);
 ...
 * the end of the array).
 */
inline void ArraySort(variant &dest[], const variant &src[], unsigned int idx,
                      unsigned int len);
 ...
 * \param dest The destination variant type (scalar or array, depending on the
 * operation).
 * \param src The source numeric array.
 * \param idx The index of the start of the array subset to process. Pass
 * \ref NA to start with the first element.
 ...
 * the end of the array).
 */
inline void ArrayOp(const byte op, variant &dest, const variant &src[],
...
#define ArraySubset(_aout, _asrc, _idx, _len)                                  \
  asm { arrsubset _aout, _asrc, _idx, _len }

#ifdef __ENHANCED_FIRMWARE
#define ArraySum(_src, _idx, _len)                                             \
  asm { arrop OPARR_SUM, __RETVAL__, _src, _idx, _len }
#define ArrayMean(_src, _idx, _len)                                            \
  asm { arrop OPARR_MEAN, __RETVAL__, _src, _idx, _len }
#define ArraySumSqr(_src, _idx, _len)                                          \
  asm { arrop OPARR_SUMSQR, __RETVAL__, _src, _idx, _len }
#define ArrayStd(_src, _idx, _len)                                             \
  asm { arrop OPARR_STD, __RETVAL__, _src, _idx, _len }
#define ArrayMin(_src, _idx, _len)                                             \
  asm { arrop OPARR_MIN, __RETVAL__, _src, _idx, _len }
#define ArrayMax(_src, _idx, _len)                                             \
  asm { arrop OPARR_MAX, __RETVAL__, _src, _idx, _len }
#define ArraySort(_dest, _src, _idx, _len)                                     \
  asm { arrop OPARR_SORT, _dest, _src, _idx, _len }
#define ArrayOp(_op, _dest, _src, _idx, _len)                                  \
  asm { arrop _op, _dest, _src, _idx, _len }
#endif
 ...
 * \param moduleName The module name of the IOMap to modify. See \ref
 * ModuleNameConstants.
 ...
 */
inline void SetIOMapBytes(string moduleName, unsigned int offset,
                          unsigned int count, byte data[]);
 ...
 */
inline void SetIOMapValue(string moduleName, unsigned int offset,
                          variant value);
 ...
 */
inline void GetIOMapBytes(string moduleName, unsigned int offset,
                          unsigned int count, byte &data[]);
 ...
 */
inline void GetIOMapValue(string moduleName, unsigned int offset,
                          variant &value);
 ...
 * module IOMap.
 */
inline void GetLowSpeedModuleBytes(unsigned int offset, unsigned int count,
                                   byte &data[]);
 ...
 * module IOMap.
 */
inline void GetDisplayModuleBytes(unsigned int offset, unsigned int count,
                                  byte &data[]);
 ...
 * module IOMap.
 */
inline void GetCommModuleBytes(unsigned int offset, unsigned int count,
                               byte &data[]);
 ...
 * module IOMap.
 */
inline void GetCommandModuleBytes(unsigned int offset, unsigned int count,
                                  byte &data[]);
 ...
 * module IOMap.
 */
inline void SetCommandModuleBytes(unsigned int offset, unsigned int count,
                                  byte data[]);
 ...
 * array containing the new data.
 * \param offset The number of bytes offset from the start of the Lowspeed
 * module IOMap structure where the data should be written. See \ref
 * LowSpeedIOMAP.
 ...
 * module IOMap.
 */
inline void SetLowSpeedModuleBytes(unsigned int offset, unsigned int count,
                                   byte data[]);
 ...
 * module IOMap.
 */
inline void SetDisplayModuleBytes(unsigned int offset, unsigned int count,
                                  byte data[]);
 ...
 * IOMap.
 */
inline void SetCommModuleBytes(unsigned int offset, unsigned int count,
                               byte data[]);
 ...
 * the IOMap structure where you want to start writing, the number of bytes to
 * write at that location, and a byte array containing the new data.
 * \param moduleId The module ID of the IOMap to modify. See \ref
 * ModuleIDConstants.
 * \param offset The number of bytes offset from the start of the IOMap
 * structure where the data should be written.
 * \param count The number of bytes to write at the specified IOMap
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline void SetIOMapBytesByID(unsigned long moduleId, unsigned int offset,
                              unsigned int count, byte data[]);
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline void SetIOMapValueByID(unsigned long moduleId, unsigned int offset,
                              variant value);
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline void GetIOMapBytesByID(unsigned long moduleId, unsigned int offset,
                              unsigned int count, byte &data[]);
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline void GetIOMapValueByID(unsigned long moduleId, unsigned int offset,
                              variant &value);
 ...
 * module IOMap structure where the new value should be written. See \ref
 * CommandIOMAP.
...
#define SetIOMapBytes(_modName, _offset, _cnt, _arrIn)                         \
  asm { __SetIOMapBytes(_modName, _offset, _cnt, _arrIn) }
#define SetIOMapValue(_modName, _offset, _n)                                   \
  asm { __SetIOMapValue(_modName, _offset, _n) }

#define GetIOMapBytes(_modName, _offset, _cnt, _arrOut)                        \
  asm { __getIOMapBytes(_modName, _offset, _cnt, _arrOut) }
#define GetIOMapValue(_modName, _offset, _n)                                   \
  asm { __getIOMapValue(_modName, _offset, _n) }

#define GetLowSpeedModuleBytes(_offset, _cnt, _arrOut)                         \
  asm { __getLowSpeedModuleBytes(_offset, _cnt, _arrOut) }
#define GetDisplayModuleBytes(_offset, _cnt, _arrOut)                          \
  asm { __getDisplayModuleBytes(_offset, _cnt, _arrOut) }
#define GetCommModuleBytes(_offset, _cnt, _arrOut)                             \
  asm { __getCommModuleBytes(_offset, _cnt, _arrOut) }

#ifdef __ENHANCED_FIRMWARE

#define SetIOMapBytesByID(_modID, _offset, _cnt, _arrIn)                       \
  asm { __SetIOMapBytesByID(_modID, _offset, _cnt, _arrIn) }
#define SetIOMapValueByID(_modID, _offset, _n)                                 \
  asm { __SetIOMapValueByID(_modID, _offset, _n) }

#define GetIOMapBytesByID(_modID, _offset, _cnt, _arrOut)                      \
  asm { __getIOMapBytesByID(_modID, _offset, _cnt, _arrOut) }
#define GetIOMapValueByID(_modID, _offset, _n)                                 \
  asm { __getIOMapValueByID(_modID, _offset, _n) }

#define SetCommandModuleValue(_offset, _n)                                     \
  SetIOMapValueByID(CommandModuleID, _offset, _n)
#define SetIOCtrlModuleValue(_offset, _n)                                      \
  SetIOMapValueByID(IOCtrlModuleID, _offset, _n)
#define SetLoaderModuleValue(_offset, _n)                                      \
  SetIOMapValueByID(LoaderModuleID, _offset, _n)
#define SetUIModuleValue(_offset, _n) SetIOMapValueByID(UIModuleID, _offset, _n)
#define SetSoundModuleValue(_offset, _n)                                       \
  SetIOMapValueByID(SoundModuleID, _offset, _n)
#define SetButtonModuleValue(_offset, _n)                                      \
  SetIOMapValueByID(ButtonModuleID, _offset, _n)
#define SetInputModuleValue(_offset, _n)                                       \
  SetIOMapValueByID(InputModuleID, _offset, _n)
#define SetOutputModuleValue(_offset, _n)                                      \
  SetIOMapValueByID(OutputModuleID, _offset, _n)
#define SetLowSpeedModuleValue(_offset, _n)                                    \
  SetIOMapValueByID(LowSpeedModuleID, _offset, _n)
#define SetDisplayModuleValue(_offset, _n)                                     \
  SetIOMapValueByID(DisplayModuleID, _offset, _n)
#define SetCommModuleValue(_offset, _n)                                        \
  SetIOMapValueByID(CommModuleID, _offset, _n)

#define SetCommandModuleBytes(_offset, _cnt, _arrIn)                           \
  SetIOMapBytesByID(CommandModuleID, _offset, _cnt, _arrIn)
#define SetLowSpeedModuleBytes(_offset, _cnt, _arrIn)                          \
  SetIOMapBytesByID(LowSpeedModuleID, _offset, _cnt, _arrIn)
#define SetDisplayModuleBytes(_offset, _cnt, _arrIn)                           \
  SetIOMapBytesByID(DisplayModuleID, _offset, _cnt, _arrIn)
#define SetCommModuleBytes(_offset, _cnt, _arrIn)                              \
  SetIOMapBytesByID(CommModuleID, _offset, _cnt, _arrIn)

#define GetCommandModuleValue(_offset, _n)                                     \
  GetIOMapValueByID(CommandModuleID, _offset, _n)
#define GetLoaderModuleValue(_offset, _n)                                      \
  GetIOMapValueByID(LoaderModuleID, _offset, _n)
#define GetSoundModuleValue(_offset, _n)                                       \
  GetIOMapValueByID(SoundModuleID, _offset, _n)
#define GetButtonModuleValue(_offset, _n)                                      \
  GetIOMapValueByID(ButtonModuleID, _offset, _n)
#define GetUIModuleValue(_offset, _n) GetIOMapValueByID(UIModuleID, _offset, _n)
#define GetInputModuleValue(_offset, _n)                                       \
  GetIOMapValueByID(InputModuleID, _offset, _n)
#define GetOutputModuleValue(_offset, _n)                                      \
  GetIOMapValueByID(OutputModuleID, _offset, _n)
#define GetLowSpeedModuleValue(_offset, _n)                                    \
  GetIOMapValueByID(LowSpeedModuleID, _offset, _n)
#define GetDisplayModuleValue(_offset, _n)                                     \
  GetIOMapValueByID(DisplayModuleID, _offset, _n)
#define GetCommModuleValue(_offset, _n)                                        \
  GetIOMapValueByID(CommModuleID, _offset, _n)

#else

#define SetCommandModuleValue(_offset, _n)                                     \
  SetIOMapValue(CommandModuleName, _offset, _n)
#define SetIOCtrlModuleValue(_offset, _n)                                      \
  SetIOMapValue(IOCtrlModuleName, _offset, _n)
#define SetLoaderModuleValue(_offset, _n)                                      \
  SetIOMapValue(LoaderModuleName, _offset, _n)
#define SetUIModuleValue(_offset, _n) SetIOMapValue(UIModuleName, _offset, _n)
#define SetSoundModuleValue(_offset, _n)                                       \
  SetIOMapValue(SoundModuleName, _offset, _n)
#define SetButtonModuleValue(_offset, _n)                                      \
  SetIOMapValue(ButtonModuleName, _offset, _n)
#define SetInputModuleValue(_offset, _n)                                       \
  SetIOMapValue(InputModuleName, _offset, _n)
#define SetOutputModuleValue(_offset, _n)                                      \
  SetIOMapValue(OutputModuleName, _offset, _n)
#define SetLowSpeedModuleValue(_offset, _n)                                    \
  SetIOMapValue(LowSpeedModuleName, _offset, _n)
#define SetDisplayModuleValue(_offset, _n)                                     \
  SetIOMapValue(DisplayModuleName, _offset, _n)
#define SetCommModuleValue(_offset, _n)                                        \
  SetIOMapValue(CommModuleName, _offset, _n)

#define SetCommandModuleBytes(_offset, _cnt, _arrIn)                           \
  SetIOMapBytes(CommandModuleName, _offset, _cnt, _arrIn)
#define SetLowSpeedModuleBytes(_offset, _cnt, _arrIn)                          \
  SetIOMapBytes(LowSpeedModuleName, _offset, _cnt, _arrIn)
#define SetDisplayModuleBytes(_offset, _cnt, _arrIn)                           \
  SetIOMapBytes(DisplayModuleName, _offset, _cnt, _arrIn)
#define SetCommModuleBytes(_offset, _cnt, _arrIn)                              \
  SetIOMapBytes(CommModuleName, _offset, _cnt, _arrIn)

#define GetCommandModuleValue(_offset, _n)                                     \
  GetIOMapValue(CommandModuleName, _offset, _n)
#define GetLoaderModuleValue(_offset, _n)                                      \
  GetIOMapValue(LoaderModuleName, _offset, _n)
#define GetSoundModuleValue(_offset, _n)                                       \
  GetIOMapValue(SoundModuleName, _offset, _n)
#define GetButtonModuleValue(_offset, _n)                                      \
  GetIOMapValue(ButtonModuleName, _offset, _n)
#define GetUIModuleValue(_offset, _n) GetIOMapValue(UIModuleName, _offset, _n)
#define GetInputModuleValue(_offset, _n)                                       \
  GetIOMapValue(InputModuleName, _offset, _n)
#define GetOutputModuleValue(_offset, _n)                                      \
  GetIOMapValue(OutputModuleName, _offset, _n)
#define GetLowSpeedModuleValue(_offset, _n)                                    \
  GetIOMapValue(LowSpeedModuleName, _offset, _n)
#define GetDisplayModuleValue(_offset, _n)                                     \
  GetIOMapValue(DisplayModuleName, _offset, _n)
#define GetCommModuleValue(_offset, _n)                                        \
  GetIOMapValue(CommModuleName, _offset, _n)
 ...
 *     <td>Send a file over a Bluetooth
 * connection</td><td>(Connection,x,x,Filename)</td></tr>
 ...
 *     <td>Connect to a Bluetooth
 * device</td><td>(DeviceIndex,Connection,x,x)</td></tr>
...
struct CommHSControlType {
  ...
  byte BaudRate; /*!< The hi-speed port baud rate. See \ref
                    CommHiSpeedBaudConstants. */
#if __FIRMWARE_VERSION > 107
  unsigned int
      Mode; /*!< The hi-speed port mode. See \ref CommHiSpeedDataBitsConstants,
                 \ref CommHiSpeedStopBitsConstants, \ref
               CommHiSpeedParityConstants, and \ref
 ...
 * Check the status of the bluetooth subsystem for the specified connection
 * slot.
 *
 ...
 * This method tells the NXT firmware to write the data in the buffer to the
 * device on the specified connection.  Use \ref RemoteConnectionIdle to
 * determine when this write request is completed.
 *
 ...
 * Read a boolean value from a mailbox and optionally remove it.  If the local
 * mailbox is empty and this NXT is the master then it attempts to poll one of
 * its slave NXTs for a message from the response mailbox that corresponds to
 * the specified local mailbox number.
 *
 * \param queue The mailbox number. See \ref MailboxConstants.
 * \param clear A flag indicating whether to remove the message from the mailbox
 * after it has been read.
 ...
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char ReceiveRemoteMessageEx(byte queue, bool clear, string &str,
                                   long &val, bool &bval);

/**
 * Read a numeric value from a queue/mailbox.
 * Read a numeric value from a mailbox and optionally remove it.  If the local
 * mailbox is empty and this NXT is the master then it attempts to poll one of
 * its slave NXTs for a message from the response mailbox that corresponds to
 * the specified local mailbox number.
 *
 ...
 * Read a string value from a mailbox and optionally remove it.  If the local
 * mailbox is empty and this NXT is the master then it attempts to poll one of
 * its slave NXTs for a message from the response mailbox that corresponds to
 * the specified local mailbox number.
 *
 ...
 * specified connection. Use \ref RemoteConnectionIdle to determine when this
 ...
 * Use \ref RemoteConnectionIdle to determine when this write request is
 * completed.
 *
 * \param conn The connection slot (0..4). Connections 0 through 3 are for
 * bluetooth connections.  Connection 4 refers to the RS485 hi-speed port.
 ...
 * \param bloop A boolean value indicating whether to loop the sound file or
 * not.
 * \return A char value indicating whether the function call succeeded or not.
 */
 ...
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char RemotePlayTone(byte conn, unsigned int frequency,
 ...
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char RemoteSetOutputState(byte conn, byte port, char speed, byte mode,
                                 byte regmode, char turnpct, byte runstate,
 ...
 * bluetooth connections.  Connection 4 refers to the RS485 hi-speed port.
 * See \ref CommConnectionConstants.
 * \param params The input and output parameters for the function call. See \ref
 * OutputStateType.
 * \return A char value indicating whether the function call succeeded or not.
 */
 ...
 * This method sends a LowspeedGetStatus direct command to the device on the
 ...
 * This method sends a GetCurrentProgramName direct command to the device on the
 * specified connection.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 *
 ...
 * bluetooth connections.  Connection 4 refers to the RS485 hi-speed port.
 * See \ref CommConnectionConstants.
 * \param remove Remove the datalog message from the queue after reading it
 * (true or false).
 ...
 * This method sends a GetContactCount direct command to the device on the
 * specified connection.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 *
 ...
 * This method sends a GetConnectionCount direct command to the device on the
 * specified connection.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 *
 ...
 * bluetooth connections.  Connection 4 refers to the RS485 hi-speed port.
 * See \ref CommConnectionConstants.
 * \param port The output port to reset the tachometer count on. See \ref
 * OutputPortConstants.
 * \return A char value indicating whether the function call succeeded or not.
 */
 ...
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char RemoteLowspeedWrite(byte conn, byte port, byte txlen, byte rxlen,
                                byte data[]);
 ...
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char RemoteOpenRead(byte conn, string filename, byte &handle,
                           long &size);
 ...
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char RemoteOpenAppendData(byte conn, string filename, byte &handle,
                                 long &size);
 ...
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char RemoteFindFirstFile(byte conn, string mask, byte &handle,
                                string &name, long &size);

/**
 * Send a GetFirmwareVersion message.
 * This method sends a GetFirmwareVersion system command to the device on the
 * specified connection.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 *
 ...
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char RemoteGetFirmwareVersion(byte conn, byte &pmin, byte &pmaj,
                                     byte &fmin, byte &fmaj);

/**
 * Send a GetBluetoothAddress message.
 * This method sends a GetBluetoothAddress system command to the device on the
 * specified connection.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 *
 ...
 * This method sends a GetDeviceInfo system command to the device on the
 * specified connection.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 *
 ...
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char RemoteGetDeviceInfo(byte conn, string &name, byte &btaddr[],
                                byte &btsignal[], long &freemem);

/**
 * Send a DeleteUserFlash message.
 * This method sends a DeleteUserFlash system command to the device on the
 * specified connection.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 *
 ...
 * bluetooth connections.  Connection 4 refers to the RS485 hi-speed port.
 * See \ref CommConnectionConstants.
 * \param filename The name of the file to open for writing (i.e., create the
 * file).
 ...
 * bluetooth connections.  Connection 4 refers to the RS485 hi-speed port.
 * See \ref CommConnectionConstants.
 * \param handle The handle returned by the last \ref FindFirstFile or
 * FindNextFile call.
 * \param name The name of the next found file.
 * \param size The size of the next found file.
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char RemoteFindNextFile(byte conn, byte &handle, string &name,
                               long &size);
 ...
 * This method sends a BluetoothFactoryReset system command to the device on the
 * specified connection. Use \ref RemoteConnectionIdle to determine when this
 * write request is completed.  This command cannot be sent over a bluetooth
 * connection.
 *
 * \param conn The connection slot (0..4). Connections 0 through 3 are for
 * bluetooth connections.  Connection 4 refers to the RS485 hi-speed port.
 ...
 * \param value A scalar variable containing the value you are writing to the
 * IOMap structure.
 * \return A char value indicating whether the function call succeeded or not.
 */
inline char RemoteIOMapWriteValue(byte conn, long id, int offset,
                                  variant value);
 ...
 * \param id The ID of the module to which to write data.
 * \param offset The offset into the IOMap structure to which to write.
 * \param data A byte array containing the data you are writing to the IOMap
 * structure.
 * \return A char value indicating whether the function call succeeded or not.
 */
 ...
 *
 * \param cmd The control command to send to the port. See \ref
 * CommHiSpeedCtrlConstants.
 * \param baud The baud rate for the RS485 port. See \ref
 * CommHiSpeedBaudConstants.
 ...
 * set to 921600 and the mode is set to 8N1 (8 data bits, no parity, 1 stop
 * bit). Data cannot be sent or received over the RS485 port until the port is
 ...
 *
 * \param buffer A byte array that will contain the data read from the RS485
 * port.
 * \return A char value indicating whether the function call succeeded or not.
 *
 * \warning This function requires the enhanced NBC/NXC firmware.
 ...
 *
 * \param sendingData A boolean value set to true on output if data is being
 * sent.
 * \param dataAvail A boolean value set to true on output if data is available
 * to be read.
 *
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
 ...
 * and writes it to the buffer provided.
 *
 ...
 * Bluetooth connection table.
 * \param conn The connection slot (0..3).
 * \return The pin code for the bluetooth device at the specified connection
 * slot.
 */
 ...
 * \param conn The connection slot (0..3).
 * \return The handle number of the bluetooth device at the specified connection
 * slot.
 */
 ...
 * within the Bluetooth connection table.
 * \param conn The connection slot (0..3).
 * \return The stream status of the bluetooth device at the specified connection
 * slot.
 */
 ...
 * This method returns the value of the output pointer of the hi-speed port
 * input buffer.
 ...
 * This method returns the value of the input pointer of the hi-speed port
 * output buffer.
 ...
 * \return The hi-speed port speed (baud rate).  See \ref
 * CommHiSpeedBaudConstants.
 */
 ...
 * \param hsSpeed The hi-speed port speed (baud rate).  See \ref
 * CommHiSpeedBaudConstants.
 */
 ...
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 */
inline void SetHSMode(unsigned int hsMode) {
  asm { __setHSMode(_n) }
}
...
#define ReceiveMessage(_queue, _clear, _msg)                                   \
  asm { __receiveMessage(_queue, _clear, _msg, __RETVAL__) }

#define BluetoothStatus(_conn) asm { __bluetoothStatus(_conn, __RETVAL__) }
#define BluetoothWrite(_conn, _buffer)                                         \
  asm { __bluetoothWrite(_conn, _buffer, __RETVAL__) }
#define RemoteConnectionWrite(_conn, _buffer)                                  \
  asm { __connectionRawWrite(_conn, _buffer, __RETVAL__) }
#define RemoteConnectionIdle(_conn)                                            \
  asm { __remoteConnectionIdle(_conn, __RETVAL__) }

#define SendRemoteBool(_conn, _queue, _bval)                                   \
  asm { __sendRemoteBool(_conn, _queue, _bval, __RETVAL__) }
#define SendRemoteNumber(_conn, _queue, _val)                                  \
  asm { __sendRemoteNumber(_conn, _queue, _val, __RETVAL__) }
#define SendRemoteString(_conn, _queue, _str)                                  \
  asm { __sendRemoteString(_conn, _queue, _str, __RETVAL__) }

#define SendResponseBool(_queue, _bval)                                        \
  asm { __sendResponseBool(_queue, _bval, __RETVAL__) }
#define SendResponseNumber(_queue, _val)                                       \
  asm { __sendResponseNumber(_queue, _val, __RETVAL__) }
#define SendResponseString(_queue, _msg)                                       \
  asm { __sendResponseString(_queue, _msg, __RETVAL__) }

#define ReceiveRemoteBool(_queue, _clear, _bval)                               \
  asm { __receiveRemoteBool(_queue, _clear, _bval, __RETVAL__) }
#define ReceiveRemoteNumber(_queue, _clear, _val)                              \
  asm { __receiveRemoteNumber(_queue, _clear, _val, __RETVAL__) }
#define ReceiveRemoteString(_queue, _clear, _str)                              \
  asm { __receiveMessage(_queue, _clear, _str, __RETVAL__) }
#define ReceiveRemoteMessageEx(_queue, _clear, _str, _val, _bval)              \
  asm { __receiveRemoteMessageEx(_queue, _clear, _str, _val, _bval, __RETVAL__) }

#define RemoteMessageRead(_conn, _queue)                                       \
  asm { __remoteMessageRead(_conn, _queue, __RETVAL__) }
#define RemoteMessageWrite(_conn, _queue, _msg)                                \
  asm { __sendRemoteString(_conn, _queue, _msg, __RETVAL__) }
#define RemoteStartProgram(_conn, _filename)                                   \
  asm { __remoteStartProgram(_conn, _filename, __RETVAL__) }
#define RemoteStopProgram(_conn)                                               \
  asm { __connectionWrite(_conn, __DCStopProgramPacket, __RETVAL__) }
#define RemotePlaySoundFile(_conn, _filename, _bloop)                          \
  asm { __remotePlaySoundFile(_conn, _filename, _bloop, __RETVAL__) }
#define RemotePlayTone(_conn, _frequency, _duration)                           \
  asm { __remotePlayTone(_conn, _frequency, _duration, __RETVAL__) }
#define RemoteStopSound(_conn)                                                 \
  asm { __connectionWrite(_conn, __DCStopSoundPacket, __RETVAL__) }
#define RemoteKeepAlive(_conn)                                                 \
  asm { __connectionWrite(_conn, __DCKeepAlivePacket, __RETVAL__) }
#define RemoteResetScaledValue(_conn, _port)                                   \
  asm { __remoteResetScaledValue(_conn, _port, __RETVAL__) }
#define RemoteResetMotorPosition(_conn, _port, _brelative)                     \
  asm { __remoteResetMotorPosition(_conn, _port, _brelative, __RETVAL__) }
#define RemoteSetInputMode(_conn, _port, _type, _mode)                         \
  asm { __remoteSetInputMode(_conn, _port, _type, _mode, __RETVAL__) }
#define RemoteSetOutputState(_conn, _port, _speed, _mode, _regmode, _turnpct,  \
                             _runstate, _tacholimit)                           \
  asm { __remoteSetOutputState(_conn, _port, _speed, _mode, _regmode, _turnpct, _runstate, _tacholimit, __RETVAL__) }
#define RemoteResetTachoCount(_conn, _port)                                    \
  asm { __remoteResetTachoCount(_conn, _port, __RETVAL__) }
#define RemoteDatalogSetTimes(_conn, _synctime)                                \
  asm { __remoteDatalogSetTimes(_conn, _synctime, __RETVAL__) }
#define RemoteSetProperty(_conn, _prop, _value)                                \
  asm { __remoteSetProperty(_conn, _prop, _value, __RETVAL__) }
#define RemoteLowspeedWrite(_conn, _port, _txlen, _rxlen, _data)               \
  asm { __remoteLowspeedWrite(_conn, _port, _txlen, _rxlen, _data, __RETVAL__) }

#ifdef __ENHANCED_FIRMWARE
#define RemoteGetOutputState(_conn, _params)                                   \
  asm { \
  compchktype _params, OutputStateType \
  __remoteGetOutputState(_conn, _params, __RETVAL__) }
#define RemoteGetInputValues(_conn, _params)                                   \
  asm { \
  compchktype _params, InputValuesType \
  __remoteGetInputValues(_conn, _params, __RETVAL__) }
#define RemoteGetBatteryLevel(_conn, _value)                                   \
  asm { __remoteGetBatteryLevel(_conn, _value, __RETVAL__) }
#define RemoteLowspeedGetStatus(_conn, _value)                                 \
  asm { __remoteLowspeedGetStatus(_conn, _value, __RETVAL__) }
#define RemoteLowspeedRead(_conn, _port, _bread, _data)                        \
  asm { __remoteLowspeedRead(_conn, _port, _bread, _data, __RETVAL__) }
#define RemoteGetCurrentProgramName(_conn, _name)                              \
  asm { __remoteGetCurrentProgramName(_conn, _name, __RETVAL__) }
#define RemoteDatalogRead(_conn, _remove, _cnt, _log)                          \
  asm { __remoteDatalogRead(_conn, _remove, _cnt, _log, __RETVAL__) }
#define RemoteGetContactCount(_conn, _cnt)                                     \
  asm { __remoteGetContactCount(_conn, _cnt, __RETVAL__) }
#define RemoteGetContactName(_conn, _idx, _name)                               \
  asm { __remoteGetContactName(_conn, _idx, _name, __RETVAL__) }
#define RemoteGetConnectionCount(_conn, _cnt)                                  \
  asm { __remoteGetConnectionCount(_conn, _cnt, __RETVAL__) }
#define RemoteGetConnectionName(_conn, _idx, _name)                            \
  asm { __remoteGetConnectionName(_conn, _idx, _name, __RETVAL__) }

#define RemoteGetProperty(_conn, _property, _value)                            \
  asm { __remoteGetProperty(_conn, _property, _value, __RETVAL__) }

#else

#define RemoteGetOutputState(_conn, _port)                                     \
  asm { __remoteGetOutputState(_conn, _port, __RETVAL__) }
#define RemoteGetInputValues(_conn, _port)                                     \
  asm { __remoteGetInputValues(_conn, _port, __RETVAL__) }
#define RemoteGetBatteryLevel(_conn)                                           \
  asm { __remoteGetBatteryLevel(_conn, __RETVAL__) }
#define RemoteLowspeedGetStatus(_conn)                                         \
  asm { __remoteLowspeedGetStatus(_conn, __RETVAL__) }
#define RemoteLowspeedRead(_conn, _port)                                       \
  asm { __remoteLowspeedRead(_conn, _port, __RETVAL__) }
#define RemoteGetCurrentProgramName(_conn)                                     \
  asm { __remoteGetCurrentProgramName(_conn, __RETVAL__) }
#define RemoteDatalogRead(_conn, _remove)                                      \
  asm { __remoteDatalogRead(_conn, _remove, __RETVAL__) }
#define RemoteGetContactCount(_conn)                                           \
  asm { __remoteGetContactCount(_conn, __RETVAL__) }
#define RemoteGetContactName(_conn, _idx)                                      \
  asm { __remoteGetContactName(_conn, _idx, __RETVAL__) }
#define RemoteGetConnectionCount(_conn)                                        \
  asm { __remoteGetConnectionCount(_conn, __RETVAL__) }
#define RemoteGetConnectionName(_conn, _idx)                                   \
  asm { __remoteGetConnectionName(_conn, _idx, __RETVAL__) }
#define RemoteGetProperty(_conn, _property)                                    \
  asm { __remoteGetProperty(_conn, _property, __RETVAL__) }

#endif

#ifdef __ENHANCED_FIRMWARE

#define RemoteOpenRead(_conn, _filename, _handle, _size)                       \
  asm { __remoteOpenRead(_conn, _filename, _handle, _size, __RETVAL__) }
#define RemoteOpenWrite(_conn, _filename, _size, _handle)                      \
  asm { __remoteOpenWrite(_conn, _filename, _size, _handle, __RETVAL__) }
#define RemoteRead(_conn, _handle, _numbytes, _data)                           \
  asm { __remoteRead(_conn, _handle, _numbytes, _data, __RETVAL__) }
#define RemoteWrite(_conn, _handle, _numbytes, _data)                          \
  asm { __remoteWrite(_conn, _handle, _numbytes, _data, __RETVAL__) }
#define RemoteCloseFile(_conn, _handle)                                        \
  asm { __remoteCloseFile(_conn, _handle, __RETVAL__) }
#define RemoteDeleteFile(_conn, _filename)                                     \
  asm { __remoteDeleteFile(_conn, _filename, __RETVAL__) }
#define RemoteDeleteUserFlash(_conn)                                           \
  asm { __remoteDeleteUserFlash(_conn, __RETVAL__) }
#define RemoteFindFirstFile(_conn, _mask, _handle, _name, _size)               \
  asm { __remoteFindFirstFile(_conn, _mask, _handle, _name, _size, __RETVAL__) }
#define RemoteFindNextFile(_conn, _handle, _name, _size)                       \
  asm { __remoteFindNextFile(_conn, _handle, _name, _size, __RETVAL__) }
#define RemoteGetFirmwareVersion(_conn, _pmin, _pmaj, _fmin, _fmaj)            \
  asm { __remoteGetFirmwareVersion(_conn, _pmin, _pmaj, _fmin, _fmaj, __RETVAL__) }
#define RemoteOpenWriteLinear(_conn, _filename, _size, _handle)                \
  asm { __remoteOpenWriteLinear(_conn, _filename, _size, _handle, __RETVAL__) }
#define RemoteOpenWriteData(_conn, _filename, _size, _handle)                  \
  asm { __remoteOpenWriteData(_conn, _filename, _size, _handle, __RETVAL__) }
#define RemoteOpenAppendData(_conn, _filename, _handle, _size)                 \
  asm { __remoteOpenAppendData(_conn, _filename, _handle, _size, __RETVAL__) }
#define RemoteGetDeviceInfo(_conn, _name, _btaddr, _btsignal, _freemem)        \
  asm { __remoteGetDeviceInfo(_conn, _name, _btaddr, _btsignal, _freemem, __RETVAL__) }
#define RemotePollCommandLength(_conn, _bufnum, _length)                       \
  asm { __remotePollCommandLength(_conn, _bufnum, _length, __RETVAL__) }
#define RemotePollCommand(_conn, _bufnum, _len, _data)                         \
  asm { __remotePollCommand(_conn, _bufnum, _len, _data, __RETVAL__) }
#define RemoteIOMapRead(_conn, _id, _offset, _numbytes, _data)                 \
  asm { __remoteIOMapRead(_conn, _id, _offset, _numbytes, _data, __RETVAL__) }
#define RemoteGetBluetoothAddress(_conn, _btaddr)                              \
  asm { __remoteGetBluetoothAddress(_conn, _btaddr, __RETVAL__) }

#define RemoteRenameFile(_conn, _oldname, _newname)                            \
  asm { __remoteRenameFile(_conn, _oldname, _newname, __RETVAL__) }

#else

#define RemoteOpenRead(_conn, _filename)                                       \
  asm { __remoteOpenRead(_conn, _filename, __RETVAL__) }
#define RemoteOpenWrite(_conn, _filename, _size)                               \
  asm { __remoteOpenWrite(_conn, _filename, _size, __RETVAL__) }
#define RemoteRead(_conn, _handle, _numbytes)                                  \
  asm { __remoteRead(_conn, _handle, _numbytes, __RETVAL__) }
#define RemoteWrite(_conn, _handle, _data)                                     \
  asm { __remoteWrite(_conn, _handle, _data, __RETVAL__) }
#define RemoteCloseFile(_conn, _handle)                                        \
  asm { __remoteCloseFile(_conn, _handle, __RETVAL__) }
#define RemoteDeleteFile(_conn, _filename)                                     \
  asm { __remoteDeleteFile(_conn, _filename, __RETVAL__) }
#define RemoteDeleteUserFlash(_conn)                                           \
  asm { __connectionWrite(_conn, __SCDeleteUserFlashPacket, __RETVAL__) }
#define RemoteFindFirstFile(_conn, _mask)                                      \
  asm { __remoteFindFirstFile(_conn, _mask, __RETVAL__) }
#define RemoteFindNextFile(_conn, _handle)                                     \
  asm { __remoteFindNextFile(_conn, _handle, __RETVAL__) }
#define RemoteGetFirmwareVersion(_conn)                                        \
  asm { __connectionWrite(_conn, __SCGetFirmwareVerPacket, __RETVAL__) }
#define RemoteOpenWriteLinear(_conn, _filename, _size)                         \
  asm { __remoteOpenWriteLinear(_conn, _filename, _size, __RETVAL__) }
#define RemoteOpenWriteData(_conn, _filename, _size)                           \
  asm { __remoteOpenWriteData(_conn, _filename, _size, __RETVAL__) }
#define RemoteOpenAppendData(_conn, _filename)                                 \
  asm { __remoteOpenAppendData(_conn, _filename, __RETVAL__) }
#define RemoteGetDeviceInfo(_conn)                                             \
  asm { __connectionWrite(_conn, __SCGetDeviceInfoPacket, __RETVAL__) }
#define RemotePollCommandLength(_conn, _bufnum)                                \
  asm { __remotePollCommandLength(_conn, _bufnum, __RETVAL__) }
#define RemotePollCommand(_conn, _bufnum, _len)                                \
  asm { __remotePollCommand(_conn, _bufnum, _len, __RETVAL__) }
#define RemoteIOMapRead(_conn, _id, _offset, _numbytes)                        \
  asm { __remoteIOMapRead(_conn, _id, _offset, _numbytes, __RETVAL__) }
#define RemoteGetBluetoothAddress(_conn)                                       \
  asm { __connectionWrite(_conn, __SCBTGetAddressPacket, __RETVAL__) }

#endif

#define RemoteBluetoothFactoryReset(_conn)                                     \
  asm { __connectionWrite(_conn, __SCBTFactoryResetPacket, __RETVAL__) }
#define RemoteIOMapWriteValue(_conn, _id, _offset, _value)                     \
  asm { __remoteIOMapWriteValue(_conn, _id, _offset, _value, __RETVAL__) }
#define RemoteIOMapWriteBytes(_conn, _id, _offset, _data)                      \
  asm { __remoteIOMapWriteBytes(_conn, _id, _offset, _data, __RETVAL__) }
#define RemoteSetBrickName(_conn, _name)                                       \
  asm { __remoteSetBrickName(_conn, _name, __RETVAL__) }

#define UseRS485() asm { __UseRS485() }

#ifdef __ENHANCED_FIRMWARE

#define RS485Status(_sendingData, _dataAvail)                                  \
  asm { __RS485Status(_sendingData, _dataAvail) }
...
#define RS485Control(_cmd, _baud, _mode)                                       \
  asm { __RS485Control(_cmd, _baud, _mode, __RETVAL__) }
#define RS485Uart(_baud, _mode)                                                \
  asm { __RS485Control(HS_CTRL_UART, _baud, _mode, __RETVAL__) }
#define RS485Initialize()                                                      \
  asm { __RS485Control(HS_CTRL_UART, HS_BAUD_DEFAULT, HS_MODE_DEFAULT, __RETVAL__) }
#define RS485Enable()                                                          \
  asm { __RS485Control(HS_CTRL_INIT, HS_BAUD_DEFAULT, HS_MODE_DEFAULT, __RETVAL__) }
#define RS485Disable()                                                         \
  asm { __RS485Control(HS_CTRL_EXIT, HS_BAUD_DEFAULT, HS_MODE_DEFAULT, __RETVAL__) }
...
#define RS485Initialize()                                                      \
  asm { __RS485Control(HS_CTRL_UART, HS_BAUD_DEFAULT, __RETVAL__) }
#define RS485Enable()                                                          \
  asm { __RS485Control(HS_CTRL_INIT, HS_BAUD_DEFAULT, __RETVAL__) }
#define RS485Disable()                                                         \
  asm { __RS485Control(HS_CTRL_EXIT, HS_BAUD_DEFAULT, __RETVAL__) }
...
#define GetBTInputBuffer(_offset, _cnt, _data)                                 \
  asm { __getBTInputBuffer(_offset, _cnt, _data) }
#define GetBTOutputBuffer(_offset, _cnt, _data)                                \
  asm { __getBTOutputBuffer(_offset, _cnt, _data) }
#define GetHSInputBuffer(_offset, _cnt, _data)                                 \
  asm { __getHSInputBuffer(_offset, _cnt, _data) }
#define GetHSOutputBuffer(_offset, _cnt, _data)                                \
  asm { __getHSOutputBuffer(_offset, _cnt, _data) }
#define GetUSBInputBuffer(_offset, _cnt, _data)                                \
  asm { __getUSBInputBuffer(_offset, _cnt, _data) }
#define GetUSBOutputBuffer(_offset, _cnt, _data)                               \
  asm { __getUSBOutputBuffer(_offset, _cnt, _data) }
#define GetUSBPollBuffer(_offset, _cnt, _data)                                 \
  asm { __getUSBPollBuffer(_offset, _cnt, _data) }
...
#define GetBTConnectionAddress(_p, _data)                                      \
  asm { __getBTConnectionAddress(_p, _data) }
#define GetBrickDataAddress(_data)                                             \
  asm { __getCommModuleBytes(CommOffsetBrickDataBdAddr, 7, _data) }

#define BTDeviceClass(_p)                                                      \
  asm { GetBTDeviceClass(_p, __TMPLONG__) __RETURN__ __TMPLONG__ }
#define BTDeviceStatus(_p)                                                     \
  asm { GetBTDeviceStatus(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BTConnectionClass(_p)                                                  \
  asm { GetBTConnectionClass(_p, __TMPLONG__) __RETURN__ __TMPLONG__ }
#define BTConnectionHandleNum(_p)                                              \
  asm { GetBTConnectionHandleNum(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BTConnectionStreamStatus(_p)                                           \
  asm { GetBTConnectionStreamStatus(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BTConnectionLinkQuality(_p)                                            \
  asm { GetBTConnectionLinkQuality(_p, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BrickDataBluecoreVersion()                                             \
  asm { GetBrickDataBluecoreVersion(__TMPWORD__) __RETURN__ __TMPWORD__ }
#define BrickDataBtStateStatus()                                               \
  asm { GetBrickDataBtStateStatus(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BrickDataBtHardwareStatus()                                            \
  asm { GetBrickDataBtHardwareStatus(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BrickDataTimeoutValue()                                                \
  asm { GetBrickDataTimeoutValue(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BTInputBufferInPtr()                                                   \
  asm { GetBTInputBufferInPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BTInputBufferOutPtr()                                                  \
  asm { GetBTInputBufferOutPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BTOutputBufferInPtr()                                                  \
  asm { GetBTOutputBufferInPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BTOutputBufferOutPtr()                                                 \
  asm { GetBTOutputBufferOutPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define HSInputBufferInPtr()                                                   \
  asm { GetHSInputBufferInPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define HSInputBufferOutPtr()                                                  \
  asm { GetHSInputBufferOutPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define HSOutputBufferInPtr()                                                  \
  asm { GetHSOutputBufferInPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define HSOutputBufferOutPtr()                                                 \
  asm { GetHSOutputBufferOutPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define USBInputBufferInPtr()                                                  \
  asm { GetUSBInputBufferInPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define USBInputBufferOutPtr()                                                 \
  asm { GetUSBInputBufferOutPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define USBOutputBufferInPtr()                                                 \
  asm { GetUSBOutputBufferInPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define USBOutputBufferOutPtr()                                                \
  asm { GetUSBOutputBufferOutPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define USBPollBufferInPtr()                                                   \
  asm { GetUSBPollBufferInPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define USBPollBufferOutPtr()                                                  \
  asm { GetUSBPollBufferOutPtr(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BTDeviceCount()                                                        \
  asm { GetBTDeviceCount(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define BTDeviceNameCount()                                                    \
  asm { GetBTDeviceNameCount(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
...
#define SetBTConnectionPinCode(_p, _code)                                      \
  asm { __setBTConnectionPinCode(_p, _code) }
#define SetBTConnectionAddress(_p, _btaddr)                                    \
  asm { __setBTConnectionAddress(_p, _btaddr) }
#define SetBrickDataName(_str)                                                 \
  SetCommModuleBytes(CommOffsetBrickDataName, 16, _str)
#define SetBrickDataAddress(_btaddr)                                           \
  SetCommModuleBytes(CommOffsetBrickDataBdAddr, 7, _btaddr)
...
#define SetBTConnectionHandleNum(_p, _n)                                       \
  asm { __setBTConnectionHandleNum(_p, _n) }
#define SetBTConnectionStreamStatus(_p, _n)                                    \
  asm { __setBTConnectionStreamStatus(_p, _n) }
#define SetBTConnectionLinkQuality(_p, _n)                                     \
  asm { __setBTConnectionLinkQuality(_p, _n) }
...
#define SetBrickDataBtHardwareStatus(_n)                                       \
  asm { __setBrickDataBtHardwareStatus(_n) }
...
#define SetBTInputBuffer(_offset, _cnt, _data)                                 \
  asm { __setBTInputBuffer(_offset, _cnt, _data) }
...
#define SetBTOutputBuffer(_offset, _cnt, _data)                                \
  asm { __setBTOutputBuffer(_offset, _cnt, _data) }
...
#define SetHSInputBuffer(_offset, _cnt, _data)                                 \
  asm { __setHSInputBuffer(_offset, _cnt, _data) }
...
#define SetHSOutputBuffer(_offset, _cnt, _data)                                \
  asm { __setHSOutputBuffer(_offset, _cnt, _data) }
...
#define SetUSBInputBuffer(_offset, _cnt, _data)                                \
  asm { __setUSBInputBuffer(_offset, _cnt, _data) }
...
#define SetUSBOutputBuffer(_offset, _cnt, _data)                               \
  asm { __setUSBOutputBuffer(_offset, _cnt, _data) }
...
#define SetUSBPollBuffer(_offset, _cnt, _data)                                 \
  asm { __setUSBPollBuffer(_offset, _cnt, _data) }
...
struct ReadButtonType {
  char Result; /*!< The function call result, \ref ERR_INVALID_PORT or \ref
                  NO_ERR. */
  byte Index;  /*!< The requested button index. See the \ref ButtonNameConstants
                  group. */
 ...
 * \return The function call result.
 */
inline char ReadButtonEx(const byte btn, bool reset, bool &pressed,
                         unsigned int &count);
...
#define ButtonPressCount(_b)                                                   \
  asm { GetButtonPressCount(_b, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define ButtonLongPressCount(_b)                                               \
  asm { GetButtonLongPressCount(_b, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define ButtonShortReleaseCount(_b)                                            \
  asm { GetButtonShortReleaseCount(_b, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define ButtonLongReleaseCount(_b)                                             \
  asm { GetButtonLongReleaseCount(_b, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define ButtonReleaseCount(_b)                                                 \
  asm { GetButtonReleaseCount(_b, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define ButtonState(_b)                                                        \
  asm { GetButtonState(_b, __TMPBYTE__) __RETURN__ __TMPBYTE__ }
...
#define SetButtonShortReleaseCount(_b, _n)                                     \
  asm { __setButtonShortReleaseCount(_b, _n) }
#define SetButtonLongReleaseCount(_b, _n)                                      \
  asm { __setButtonLongReleaseCount(_b, _n) }
...
struct SetSleepTimeoutType {
  ...
  unsigned long
      TheSleepTimeoutMS; /*!< The new sleep timeout value in milliseconds. */
};
#endif
 ...
 * This function lets you set the system sleep timeout value given the
 * parameters you pass in via the \ref SetSleepTimeoutType structure.
 *
 * \param args The SetSleepTimeoutType structure containing the required
 * parameters.
 *
 * \warning This function requires an NXT 2.0 compatible firmware.
 */
...
#define BluetoothState()                                                       \
  asm { GetBluetoothState(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define UsbState() asm { GetUsbState(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
...
#define RechargeableBattery()                                                  \
  asm { GetRechargeableBattery(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define Volume() asm { GetVolume(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
#define OnBrickProgramPointer()                                                \
  asm { GetOnBrickProgramPointer(__TMPBYTE__) __RETURN__ __TMPBYTE__ }
...
#if __FIRMWARE_VERSION > 107
#define SysSetSleepTimeout(_args)                                              \
  asm { \
 ...
 * This structure is used when calling the \ref SysFileRead and \ref
 * SysFileWrite system call functions.
 ...
 * This structure is used when calling the \ref SysFileClose system call
 * function.
 * \sa SysFileClose()
 */
...
struct FileResolveHandleType {
  unsigned int
      Result;       /*!< The function call result. Possible values
 ...
 * This structure is used when calling the \ref SysFileSeek system call
 * function.
 * \sa SysFileSeek()
 */
struct FileSeekType {
  ...
  byte Origin;         /*!< The origin of the file seek operation. See \ref
                          fseekConstants. */
 ...
 * This structure is used when calling the \ref SysFileResize system call
 * function.
 * \sa SysFileResize()
 */
 ...
 * This structure is used when calling the \ref SysFileTell system call
 * function.
 * \sa SysFileTell()
 */
struct FileTellType {
 ...
 * This structure is used when calling the \ref SysListFiles system call
 * function.
 * \sa SysListFiles()
 */
 ...
 * \return The function call result. See \ref LoaderErrors.
 */
inline unsigned int OpenFileAppend(string fname, unsigned int &fsize,
                                   byte &handle);
 ...
 * \return The function call result. See \ref LoaderErrors.
 */
inline unsigned int OpenFileRead(string fname, unsigned int &fsize,
                                 byte &handle);
 ...
 * \return The function call result. See \ref LoaderErrors.
 */
inline unsigned int ResolveHandle(string filename, byte &handle,
                                  bool &writeable);
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline unsigned int CreateFileLinear(string fname, unsigned int fsize,
                                     byte &handle);

/**
 * Create a non-linear file.
 * Create a new non-linear file with the specified filename and size and open it
 * for writing. The file handle is returned in the last parameter, which must be
 * a variable. The loader result code is returned as the value of the function
 * call. The filename and size parameters must be constants, constant
 * expressions, or variables. A file created with a size of zero bytes cannot
 * be written to since the NXC file writing functions do not grow the file if
 * its capacity is exceeded during a write attempt.
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline unsigned int CreateFileNonLinear(string fname, unsigned int fsize,
                                        byte &handle);

/**
 * Open a linear file for reading.
 * Open an existing linear file with the specified filename for reading. The
 * file size is returned in the second parameter, which must be a variable. The
 * file handle is returned in the last parameter, which must be a variable.
 * The loader result code is returned as the value of the function call. The
 * filename parameter must be a constant or a variable.
 *
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline unsigned int OpenFileReadLinear(string fname, unsigned int &fsize,
                                       byte &handle);
 ...
 *
 * \param handle The file handle.
 * \param length The number of bytes to read. Returns the number of bytes
 * actually read.
 ...
 * \return The function call result. See \ref LoaderErrors.
 */
inline unsigned int WriteBytes(byte handle, const byte &buf[],
                               unsigned int &cnt);
 ...
 * \return The function call result. See \ref LoaderErrors.
 */
inline unsigned int WriteBytesEx(byte handle, unsigned int &len,
                                 const byte &buf[]);
 ...
 * \return The function call result. See \ref LoaderErrors.
 */
inline unsigned int WriteLnString(byte handle, const string &str,
                                  unsigned int &cnt);
 ...
 * \return The function call result. See \ref LoaderErrors.
 */
inline unsigned int WriteString(byte handle, const string &str,
                                unsigned int &cnt);
...
#define CreateFile(_fname, _fsize, _handle)                                    \
  asm { __createFile(_fname, _fsize, _handle, __RETVAL__) }
#define OpenFileAppend(_fname, _fsize, _handle)                                \
  asm { __openFileAppend(_fname, _fsize, _handle, __RETVAL__) }
#define OpenFileRead(_fname, _fsize, _handle)                                  \
  asm { __openFileRead(_fname, _fsize, _handle, __RETVAL__) }
#define CloseFile(_handle) asm { __closeFile(_handle, __RETVAL__) }
#define ResolveHandle(_fname, _handle, _writeable)                             \
  asm { __resolveHandle(_fname, _handle, _writeable, __RETVAL__) }
#define RenameFile(_oldname, _newname)                                         \
  asm { __renameFile(_oldname, _newname, __RETVAL__) }
#define DeleteFile(_fname) asm { __deleteFile(_fname, __RETVAL__) }
#define ResizeFile(_fname, _newsize)                                           \
  asm { __fileResize(_fname, _newsize, __RETVAL__) }

#ifdef __ENHANCED_FIRMWARE
#define CreateFileLinear(_fname, _fsize, _handle)                              \
  asm { __createFileLinear(_fname, _fsize, _handle, __RETVAL__) }
#define CreateFileNonLinear(_fname, _fsize, _handle)                           \
  asm { __createFileNonLinear(_fname, _fsize, _handle, __RETVAL__) }
#define OpenFileReadLinear(_fname, _fsize, _handle)                            \
  asm { __openFileReadLinear(_fname, _fsize, _handle, __RETVAL__) }
#define FindFirstFile(_fname, _handle)                                         \
  asm { __findFirstFile(_fname, _handle, __RETVAL__) }
#define FindNextFile(_fname, _handle)                                          \
  asm { __findNextFile(_fname, _handle, __RETVAL__) }
#endif
...
#define ReadBytes(_handle, _len, _buf)                                         \
  asm { __readBytes(_handle, _len, _buf, __RETVAL__) }
#define ReadLnString(_handle, _output)                                         \
  asm { __readLnString(_handle, _output, __RETVAL__) }
...
#define WriteString(_handle, _str, _cnt)                                       \
  asm { __writeString(_handle, _str, _cnt, __RETVAL__) }
#define WriteLnString(_handle, _str, _cnt)                                     \
  asm { __writeLnString(_handle, _str, _cnt, __RETVAL__) }
#define WriteBytes(_handle, _buf, _cnt)                                        \
  asm { __writeBytes(_handle, _buf, _cnt, __RETVAL__) }
#define WriteBytesEx(_handle, _len, _buf)                                      \
  asm { __writeBytesEx(_handle, _len, _buf, __RETVAL__) }

#define SysFileOpenRead(_args)                                                 \
  asm { \
  compchktype _args, FileOpenType \
  syscall FileOpenRead, _args }
#define SysFileOpenWrite(_args)                                                \
  asm { \
  compchktype _args, FileOpenType \
  syscall FileOpenWrite, _args }
#define SysFileOpenAppend(_args)                                               \
  asm { \
  compchktype _args, FileOpenType \
  syscall FileOpenAppend, _args }
#define SysFileRead(_args)                                                     \
  asm { \
  compchktype _args, FileReadWriteType \
  syscall FileRead, _args }
#define SysFileWrite(_args)                                                    \
  asm { \
  compchktype _args, FileReadWriteType \
  syscall FileWrite, _args }
#define SysFileClose(_args)                                                    \
  asm { \
  compchktype _args, FileCloseType \
  syscall FileClose, _args }
#define SysFileResolveHandle(_args)                                            \
  asm { \
  compchktype _args, FileResolveHandleType \
  syscall FileResolveHandle, _args }
#define SysFileRename(_args)                                                   \
  asm { \
  compchktype _args, FileRenameType \
  syscall FileRename, _args }
#define SysFileDelete(_args)                                                   \
  asm { \
  compchktype _args, FileDeleteType \
  syscall FileDelete, _args }

#ifdef __ENHANCED_FIRMWARE
#define SysLoaderExecuteFunction(_args)                                        \
  asm { \
  compchktype _args, LoaderExecuteFunctionType \
  syscall LoaderExecuteFunction, _args }
#define SysFileFindFirst(_args)                                                \
  asm { \
  compchktype _args, FileFindType \
  syscall FileFindFirst, _args }
#define SysFileFindNext(_args)                                                 \
  asm { \
  compchktype _args, FileFindType \
  syscall FileFindNext, _args }
#define SysFileOpenWriteLinear(_args)                                          \
  asm { \
  compchktype _args, FileOpenType \
  syscall FileOpenWriteLinear, _args }
#define SysFileOpenWriteNonLinear(_args)                                       \
  asm { \
  compchktype _args, FileOpenType \
  syscall FileOpenWriteNonLinear, _args }
#define SysFileOpenReadLinear(_args)                                           \
  asm { \
  compchktype _args, FileOpenType \
  syscall FileOpenReadLinear, _args }
#if __FIRMWARE_VERSION > 107
#define SysFileSeek(_args)                                                     \
  asm { \
  compchktype _args, FileSeekType \
  syscall FileSeek, _args }
#define SysFileResize(_args)                                                   \
  asm { \
  compchktype _args, FileResizeType \
  syscall FileResize, _args }
#define SysFileTell(_args)                                                     \
  asm { \
...
inline void SetSensorHTEOPD(const byte &port, bool bStandard) {
  SetSensorType(port, bStandard ? SENSOR_TYPE_LIGHT_INACTIVE
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTColor(const byte port, byte &ColorNum, byte &Red,
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTIRSeeker(const byte port, byte &dir, byte &s1, byte &s3,
                                 byte &s5, byte &s7, byte &s9);
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTNormalizedColor(const byte port, byte &ColorIdx,
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTRawColor(const byte port, unsigned int &Red,
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTColor2Active(byte port, byte &ColorNum, byte &Red,
                                     byte &Green, byte &Blue, byte &White);
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTNormalizedColor2Active(const byte port, byte &ColorIdx,
                                               byte &Red, byte &Green,
                                               byte &Blue);
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTRawColor2(const byte port, unsigned int &Red,
                                  unsigned int &Green, unsigned int &Blue,
                                  unsigned int &White);
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTIRReceiverEx(const byte port, const byte offset,
                                     char &pfchar);
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTIRSeeker2AC(const byte port, byte &dir, byte &s1,
                                    byte &s3, byte &s5, byte &s7, byte &s9);
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTIRSeeker2DC(const byte port, byte &dir, byte &s1,
                                    byte &s3, byte &s5, byte &s7, byte &s9,
                                    byte &avg);
 ...
 * \return The function call result.
 */
inline bool ReadSensorHTAngle(const byte port, int &Angle, long &AccAngle,
                              int &RPM);
 ...
 */
inline void ReadSensorHTTouchMultiplexer(const byte port, byte &t1, byte &t2,
                                         byte &t3, byte &t4);
 ...
 * \ref TRAIN_FUNC_INCR_SPEED, \ref TRAIN_FUNC_DECR_SPEED, and \ref
 * TRAIN_FUNC_TOGGLE_LIGHT. Valid channel values are \ref TRAIN_CHANNEL_1
 * through \ref TRAIN_CHANNEL_3 and
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char HTPFComboDirect(const byte port, const byte channel,
                            const byte outa, const byte outb);
 ...
 * are \ref PF_PWM_FLOAT, \ref PF_PWM_FWD1, \ref PF_PWM_FWD2, \ref PF_PWM_FWD3,
 * \ref PF_PWM_FWD4,
 * \ref PF_PWM_FWD5, \ref PF_PWM_FWD6, \ref PF_PWM_FWD7, \ref PF_PWM_BRAKE, \ref
 * PF_PWM_REV7,
 * \ref PF_PWM_REV6, \ref PF_PWM_REV5, \ref PF_PWM_REV4, \ref PF_PWM_REV3, \ref
 * PF_PWM_REV2, and
 * \ref PF_PWM_REV1. Valid channels are \ref PF_CHANNEL_1 through \ref
 * PF_CHANNEL_4. The port must be configured as a Lowspeed port before using
 * this function.
 *
 * \param port The sensor port. See \ref InPorts.
 * \param channel The Power Function channel.  See \ref PFChannelConstants.
 * \param outa The Power Function PWM command for output A. See \ref
 * PFPWMOptions.
 * \param outb The Power Function PWM command for output B. See \ref
 * PFPWMOptions.
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char HTPFComboPWM(const byte port, const byte channel, const byte outa,
                         const byte outb);
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char HTPFRawOutput(const byte port, const byte nibble0,
                          const byte nibble1, const byte nibble2);
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char HTPFRepeat(const byte port, const byte count,
 ...
 * using \ref PF_OUT_A or \ref PF_OUT_B. Valid functions are \ref
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char HTPFSingleOutputCST(const byte port, const byte channel,
                                const byte out, const byte func);
 ...
 * \ref PF_PWM_FLOAT, \ref PF_PWM_FWD1, \ref PF_PWM_FWD2, \ref PF_PWM_FWD3, \ref
 * PF_PWM_FWD4,
 * \ref PF_PWM_FWD5, \ref PF_PWM_FWD6, \ref PF_PWM_FWD7, \ref PF_PWM_BRAKE, \ref
 * PF_PWM_REV7,
 * \ref PF_PWM_REV6, \ref PF_PWM_REV5, \ref PF_PWM_REV4, \ref PF_PWM_REV3, \ref
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char HTPFSingleOutputPWM(const byte port, const byte channel,
                                const byte out, const byte func);
 ...
 * channel using the HiTechnic iRLink device. Select the desired output
 * using \ref PF_OUT_A or \ref PF_OUT_B.  Select the desired pin using \ref
 * PF_PIN_C1 or
 * \ref PF_PIN_C2. Valid functions are \ref PF_FUNC_NOCHANGE, \ref
 * PF_FUNC_CLEAR,
 * \ref PF_FUNC_SET, and \ref PF_FUNC_TOGGLE. Valid channels are \ref
 * PF_CHANNEL_1 through
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char HTPFSinglePin(const byte port, const byte channel, const byte out,
                          const byte pin, const byte func, bool cont);
 ...
 * receiver. Valid function values are \ref TRAIN_FUNC_STOP, \ref
 * TRAIN_FUNC_INCR_SPEED,
 * \ref TRAIN_FUNC_DECR_SPEED, and \ref TRAIN_FUNC_TOGGLE_LIGHT. Valid channels
 * are
 * \ref PF_CHANNEL_1 through \ref PF_CHANNEL_4. The port must be configured as a
 * Lowspeed port before using this function.
 *
...
/**
 * HTRCXFwd function.
 * Send commands to an RCX to set the specified outputs to the forward
 * direction.
 *
 ...
 * direction.
 *
 * \param outputs The RCX output(s) to turn on in the forward direction. See
 * \ref RCXOutputConstants.
 */
inline void HTRCXOnFwd(const byte outputs);

/**
 * HTRCXOnRev function.
 * Send commands to an RCX to turn on the specified outputs in the reverse
 * direction.
 *
 * \param outputs The RCX output(s) to turn on in the reverse direction. See
 * \ref RCXOutputConstants.
 */
...
/**
 * HTRCXRev function.
 * Send commands to an RCX to set the specified outputs to the reverse
 * direction.
 *
 * \param outputs The RCX output(s) to reverse direction. See \ref
 * RCXOutputConstants.
 */
 ...
 * Send the SetDirection command to an RCX to configure the direction of the
 * specified outputs.
 *
 * \param outputs The RCX output(s) to set direction. See \ref
 * RCXOutputConstants.
 ...
 *
 * \param outputs The RCX output(s) to set global direction. See \ref
 * RCXOutputConstants.
 * \param dir The RCX output direction. See \ref RCXOutputDirection.
 */
 ...
 *
 * \param outputs The RCX output(s) to set global mode. See \ref
 * RCXOutputConstants.
 ...
 *
 * \param outputs The RCX output(s) to set max power. See \ref
 * RCXOutputConstants.
 * \param pwrsrc The RCX source.  See \ref RCXSourceConstants.
 * \param pwrval The RCX value.
 */
inline void HTRCXSetMaxPower(const byte outputs, const byte pwrsrc,
                             const byte pwrval);
 ...
 * Send the SetOutput command to an RCX to configure the mode of the specified
 * outputs
 *
 ...
 * Send the SetPower command to an RCX to configure the power level of the
 * specified outputs.
 *
 ...
 * \param pwrval The RCX value.
 */
inline void HTRCXSetPower(const byte outputs, const byte pwrsrc,
                          const byte pwrval);
 ...
 *
 * \param x Set the light on or off using this value. See \ref
 * ScoutLightConstants.
 */
 ...
 * \param value The Scout value.
 */
inline void HTScoutSetSensorHysteresis(const byte src,
 ...
 * \param value The Scout value.
 */
inline void HTScoutSetSensorLowerLimit(const byte src,
                                       const unsigned int value);
 ...
 * \param value The Scout value.
 */
inline void HTScoutSetSensorUpperLimit(const byte src,
                                       const unsigned int value);
...
#define ReadSensorHTAccel(_port, _x, _y, _z)                                   \
  asm { __ReadSensorHTAccel(_port, _x, _y, _z, __RETVAL__) }
#define ReadSensorHTColor(_port, _ColorNum, _Red, _Green, _Blue)               \
  asm { __ReadSensorHTColor(_port, _ColorNum, _Red, _Green, _Blue, __RETVAL__) }
#define ReadSensorHTRawColor(_port, _Red, _Green, _Blue)                       \
  asm { __ReadSensorHTRawColor(_port, _Red, _Green, _Blue, __RETVAL__) }
#define ReadSensorHTNormalizedColor(_port, _ColorIdx, _Red, _Green, _Blue)     \
  asm { __ReadSensorHTNormalizedColor(_port, _ColorIdx, _Red, _Green, _Blue, __RETVAL__) }
#define ReadSensorHTIRSeeker(_port, _dir, _s1, _s3, _s5, _s7, _s9)             \
  asm { __ReadSensorHTIRSeeker(_port, _dir, _s1, _s3, _s5, _s7, _s9, __RETVAL__) }
#define SensorHTIRSeekerDir(_port)                                             \
  asm { ReadSensorHTIRSeekerDir(_port, __RETVAL__) }
...
#define ReadSensorHTTouchMultiplexer(_p, _t1, _t2, _t3, _t4)                   \
  asm { __ReadSensorHTTouchMultiplexer(_p, _t1, _t2, _t3, _t4) }
#define SensorHTIRSeeker2Addr(_port, _reg)                                     \
  asm { ReadSensorHTIRSeeker2Addr(_port, _reg, __RETVAL__) }
#define SensorHTIRSeeker2DCDir(_port)                                          \
  asm { ReadSensorHTIRSeeker2Addr(_port, HTIR2_REG_DCDIR, __RETVAL__) }
#define SensorHTIRSeeker2ACDir(_port)                                          \
  asm { ReadSensorHTIRSeeker2Addr(_port, HTIR2_REG_ACDIR, __RETVAL__) }
#define ReadSensorHTIRSeeker2DC(_port, _dir, _s1, _s3, _s5, _s7, _s9, _avg)    \
  asm { __ReadSensorHTIRSeeker2DC(_port, _dir, _s1, _s3, _s5, _s7, _s9, _avg, __RETVAL__) }
#define ReadSensorHTIRSeeker2AC(_port, _dir, _s1, _s3, _s5, _s7, _s9)          \
  asm { __ReadSensorHTIRSeeker2AC(_port, _dir, _s1, _s3, _s5, _s7, _s9, __RETVAL__) }
#define SetHTIRSeeker2Mode(_port, _mode)                                       \
  asm { __SetHTIRSeeker2Mode(_port, _mode, __RETVAL__) }

#define SetHTColor2Mode(_port, _mode)                                          \
  asm { __SetHTColor2Mode(_port, _mode, __RETVAL__) }
#define ReadSensorHTColor2Active(_port, _ColorNum, _Red, _Green, _Blue,        \
                                 _White)                                       \
  asm { __ReadSensorHTColor2Active(_port, _ColorNum, _Red, _Green, _Blue, _White, __RETVAL__) }
#define ReadSensorHTNormalizedColor2Active(_port, _ColorIdx, _Red, _Green,     \
                                           _Blue)                              \
  asm { __ReadSensorHTNormalizedColor2Active(_port, _ColorIdx, _Red, _Green, _Blue, __RETVAL__) }
#define ReadSensorHTRawColor2(_port, _Red, _Green, _Blue, _White)              \
  asm { __ReadSensorHTRawColor2(_port, _Red, _Green, _Blue, _White, __RETVAL__) }
#define ReadSensorHTIRReceiver(_port, _pfdata)                                 \
  asm { __ReadSensorHTIRReceiver(_port, _pfdata, __RETVAL__) }
#define ReadSensorHTIRReceiverEx(_port, _reg, _pfchar)                         \
  asm { __ReadSensorHTIRReceiverEx(_port, _reg, _pfchar, __RETVAL__) }
#define ResetSensorHTAngle(_port, _mode)                                       \
  asm { __ResetSensorHTAngle(_port, _mode, __RETVAL__) }
#define ReadSensorHTAngle(_port, _Angle, _AccAngle, _RPM)                      \
  asm { __ReadSensorHTAngle(_port, _Angle, _AccAngle, _RPM, __RETVAL__) }

#define HTPowerFunctionCommand(_port, _channel, _outa, _outb)                  \
  asm { __HTPFComboDirect(_port, _channel, _outa, _outb, __RETVAL__) }
#define HTPFComboDirect(_port, _channel, _outa, _outb)                         \
  asm { __HTPFComboDirect(_port, _channel, _outa, _outb, __RETVAL__) }
#define HTPFSinglePin(_port, _channel, _out, _pin, _func, _cont)               \
  asm { __HTPFSinglePin(_port, _channel, _out, _pin, _func, _cont, __RETVAL__) }
#define HTPFSingleOutputCST(_port, _channel, _out, _func)                      \
  asm { __HTPFSingleOutput(_port, _channel, _out, _func, TRUE, __RETVAL__) }
#define HTPFSingleOutputPWM(_port, _channel, _out, _func)                      \
  asm { __HTPFSingleOutput(_port, _channel, _out, _func, FALSE, __RETVAL__) }
#define HTPFComboPWM(_port, _channel, _outa, _outb)                            \
  asm { __HTPFComboPWM(_port, _channel, _outa, _outb, __RETVAL__) }
#define HTPFTrain(_port, _channel, _func)                                      \
  asm { __HTIRTrain(_port, _channel, _func, TRUE, __RETVAL__) }
#define HTIRTrain(_port, _channel, _func)                                      \
  asm { __HTIRTrain(_port, _channel, _func, FALSE, __RETVAL__) }
#define HTPFRawOutput(_port, _nibble0, _nibble1, _nibble2)                     \
  asm { __HTPFRawOutput(_port, _nibble0, _nibble1, _nibble2, __RETVAL__) }
#define HTPFRepeat(_port, _count, _delay)                                      \
  asm { __HTPFRepeatLastCommand(_port, _count, _delay, __RETVAL__) }
...
#define HTRCXSetDirection(_outputs, _dir)                                      \
  asm { __HTRCXSetDirection(_outputs, _dir) }
#define HTRCXSetPower(_outputs, _pwrsrc, _pwrval)                              \
  asm { __HTRCXSetPower(_outputs, _pwrsrc, _pwrval) }
...
#define HTRCXToggle(_outputs)                                                  \
  asm { __HTRCXSetDirection(_outputs, RCX_OUT_TOGGLE) }
...
#define HTRCXPlayToneVar(_varnum, _duration)                                   \
  asm { __HTRCXPlayToneVar(_varnum, _duration) }
#define HTRCXSetWatch(_hours, _minutes) asm { __HTRCXSetWatch(_hours, _minutes) }
#define HTRCXSetSensorType(_port, _type)                                       \
  asm { __HTRCXSetSensorType(_port, _type) }
#define HTRCXSetSensorMode(_port, _mode)                                       \
  asm { __HTRCXSetSensorMode(_port, _mode) }
...
#define HTRCXSelectDisplay(_src, _value)                                       \
  asm { __HTRCXSelectDisplay(_src, _value) }
#define HTRCXPollMemory(_memaddress)                                           \
  asm { __HTRCXPollMemory(_memaddress, __RETVAL__) }
#define HTRCXSetEvent(_evt, _src, _type) asm { __HTRCXSetEvent(_evt, _src, _type) }
#define HTRCXSetGlobalOutput(_outputs, _mode)                                  \
  asm { __HTRCXSetGlobalOutput(_outputs, _mode) }
#define HTRCXSetGlobalDirection(_outputs, _dir)                                \
  asm { __HTRCXSetGlobalDirection(_outputs, _dir) }
#define HTRCXSetMaxPower(_outputs, _pwrsrc, _pwrval)                           \
  asm { __HTRCXSetMaxPower(_outputs, _pwrsrc, _pwrval) }
#define HTRCXEnableOutput(_outputs)                                            \
  asm { __HTRCXSetGlobalOutput(_outputs, RCX_OUT_ON) }
#define HTRCXDisableOutput(_outputs)                                           \
  asm { __HTRCXSetGlobalOutput(_outputs, RCX_OUT_OFF) }
#define HTRCXInvertOutput(_outputs)                                            \
  asm { __HTRCXSetGlobalDirection(_outputs, RCX_OUT_REV) }
#define HTRCXObvertOutput(_outputs)                                            \
  asm { __HTRCXSetGlobalDirection(_outputs, RCX_OUT_FWD) }
...
#define HTScoutSetSensorClickTime(_src, _value)                                \
  asm { __HTScoutSetSensorClickTime(_src, _value) }
#define HTScoutSetSensorHysteresis(_src, _value)                               \
  asm { __HTScoutSetSensorHysteresis(_src, _value) }
#define HTScoutSetSensorLowerLimit(_src, _value)                               \
  asm { __HTScoutSetSensorLowerLimit(_src, _value) }
#define HTScoutSetSensorUpperLimit(_src, _value)                               \
 ...
 * should be configured for the NXTSumoEyes device using \ref
 * SetSensorNXTSumoEyes before calling this function.
 *
 * \param port The sensor port. See \ref InPorts.
 * \return The mindsensors NXTSumoEyes obstacle zone value.  See \ref
...
char SensorNXTSumoEyes(const byte &port) {
  ...
  if (value > 30 && value < 36) return NXTSE_ZONE_LEFT;
 ...
 *
 * \param port The sensor port. See \ref InPorts.
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 * value.
 ...
 * \return The function call result.
 */
inline bool ReadSensorMSAccel(const byte port, const byte i2caddr, int &x,
                              int &y, int &z);
 ...
 * \return The function call result.
 */
inline bool ReadSensorMSPlayStation(const byte port, const byte i2caddr,
                                    byte &btnset1, byte &btnset2, byte &xleft,
                                    byte &yleft, byte &xright, byte &yright);
 ...
 * \return The function call result.
 */
inline bool ReadSensorMSRTClock(const byte port, byte &sec, byte &min,
                                byte &hrs, byte &dow, byte &date, byte &month,
                                byte &year);
 ...
 * \return The function call result.
 */
inline bool ReadSensorMSTilt(const byte &port, const byte &i2caddr, byte &x,
                             byte &y, byte &z);
 ...
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 * value.
 * \param channel The power function IR receiver channel. See the \ref
 * PFMateChannelConstants group.
 * \param motors The motor(s) to control. See the \ref PFMateMotorConstants
 * group.
 ...
 * \return The function call result.
 */
inline bool PFMateSend(const byte &port, const byte &i2caddr,
                       const byte &channel, const byte &motors,
                       const byte &cmdA, const byte &spdA, const byte &cmdB,
                       const byte &spdB);
 ...
 * \return The function call result.
 */
inline bool PFMateSendRaw(const byte &port, const byte &i2caddr,
                          const byte &channel, const byte &b1, const byte &b2);

/**
 * Read a mindsensors device value.
 * Read a one, two, or four byte value from a mindsensors sensor. The value must
 * be stored with the least signficant byte (LSB) first (i.e., little endian).
 * Returns a boolean value indicating whether or not the operation completed
 * successfully. The port must be configured as a Lowspeed port before using
 * this function.
 *
 ...
 * \param numbytes The number of bytes to read. Only 1, 2 or 4 byte values are
 * supported.
 * \return The function call result.
 */
inline int MSReadValue(const byte port, const byte i2caddr, const byte reg,
                       const byte numbytes);
 ...
 * Reset the mindsensors ACCL-Nx sensor calibration to factory settings. The
 ...
 * \return The function call result.
 */
inline char SetACCLNxSensitivity(const byte port, const byte i2caddr,
                                 byte slevel);
 ...
 */
inline unsigned int NXTServoPosition(const byte &port, const byte &i2caddr,
                                     const byte servo);
 ...
 */
inline byte NXTServoSpeed(const byte &port, const byte &i2caddr,
                          const byte servo);
 ...
 * \return A status code indicating whether the operation completed successfully
 * or not. See \ref CommLSCheckStatusType for possible result values.
 */
inline char SetNXTServoSpeed(const byte &port, const byte &i2caddr,
                             const byte servo, const byte &speed);

/**
 * Set NXTServo servo motor quick position.
 * Set the quick position of a servo motor controlled by the NXTServo device.
 * The port must be configured as a Lowspeed port before using this function.
 *
 * \param port The sensor port. See \ref NBCInputPortConstants.
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 ...
 * or not. See \ref CommLSCheckStatusType for possible result values.
 */
inline char SetNXTServoQuickPosition(const byte &port, const byte &i2caddr,
                                     const byte servo, const byte &qpos);
 ...
 * or not. See \ref CommLSCheckStatusType for possible result values.
 */
inline char SetNXTServoPosition(const byte &port, const byte &i2caddr,
                                const byte servo, const byte &pos);
 ...
 * currently executing macro, and save the environment for subsequent
 * resumption. The port must be configured as a Lowspeed port before using this
 * function.
 *
 * \param port The sensor port. See \ref NBCInputPortConstants.
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 ...
 * or not. See \ref CommLSCheckStatusType for possible result values.
 */
inline char NXTServoInit(const byte &port, const byte &i2caddr,
                         const byte servo);
 ...
 * or not. See \ref CommLSCheckStatusType for possible result values.
 */
inline char NXTServoGotoMacroAddress(const byte &port, const byte &i2caddr,
                                     const byte &macro);
 ...
 * or not. See \ref CommLSCheckStatusType for possible Result values.
 */
inline char NXTHIDLoadCharacter(const byte &port, const byte &i2caddr,
                                const byte &modifier, const byte &character);
 ...
 * Read the mindsensors NXTPowerMeter device's capacity used since the last
 * reset command. The port must be configured as a Lowspeed port before using
 * this function.
 *
 * \param port The sensor port. See \ref InPorts.
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 ...
 * Read the mindsensors NXTPowerMeter device's total power consumed since the
 * last reset command. The port must be configured as a Lowspeed port before
 * using this function.
 *
 * \param port The sensor port. See \ref InPorts.
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 ...
 */
inline long NXTPowerMeterTotalPowerConsumed(const byte &port,
                                            const byte &i2caddr);
 ...
 * Read the mindsensors NXTPowerMeter device's elapsed time since the last reset
 * command. The port must be configured as a Lowspeed port before using this
 * function.
 *
 * \param port The sensor port. See \ref InPorts.
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 ...
 * happens or you can specifically wake it up by using the \ref
 * NXTLineLeaderPowerUp command. The port must be configured as a Lowspeed port
 * before using this function.
 *
 * \param port The sensor port. See \ref NBCInputPortConstants.
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 ...
 * When all 8 sensors are over a black surface the result will be 255
 * (b11111111). The port must be configured as a Lowspeed port before using this
 * function.
 *
 * \param port The sensor port. See \ref NBCInputPortConstants.
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 ...
 * or not. See \ref CommLSCheckStatusType for possible Result values.
 */
inline char SetNXTLineLeaderSetpoint(const byte &port, const byte &i2caddr,
                                     const byte &value);
 ...
 * or not. See \ref CommLSCheckStatusType for possible Result values.
 */
inline char SetNXTLineLeaderKpValue(const byte &port, const byte &i2caddr,
                                    const byte &value);
 ...
 * or not. See \ref CommLSCheckStatusType for possible Result values.
 */
inline char SetNXTLineLeaderKiValue(const byte &port, const byte &i2caddr,
                                    const byte &value);
 ...
 * or not. See \ref CommLSCheckStatusType for possible Result values.
 */
inline char SetNXTLineLeaderKdValue(const byte &port, const byte &i2caddr,
                                    const byte &value);
 ...
 * or not. See \ref CommLSCheckStatusType for possible Result values.
 */
inline char SetNXTLineLeaderKpFactor(const byte &port, const byte &i2caddr,
                                     const byte &value);
 ...
 * or not. See \ref CommLSCheckStatusType for possible Result values.
 */
inline char SetNXTLineLeaderKiFactor(const byte &port, const byte &i2caddr,
                                     const byte &value);
 ...
 * or not. See \ref CommLSCheckStatusType for possible Result values.
 */
inline char SetNXTLineLeaderKdFactor(const byte &port, const byte &i2caddr,
                                     const byte &value);
 ...
 * \return The function call result.
 */
inline char RunNRLinkMacro(const byte port, const byte i2caddr,
                           const byte macro);
 ...
 * \return The function call result.
 */
inline char WriteNRLinkBytes(const byte port, const byte i2caddr,
                             const byte data[]);
 ...
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 * value.
 * \param data A byte array that will contain the data read from the device on
 * output.
 * \return The function call result.
 */
 ...
 * \ref TRAIN_FUNC_INCR_SPEED, \ref TRAIN_FUNC_DECR_SPEED, and \ref
 * TRAIN_FUNC_TOGGLE_LIGHT. Valid channels are \ref TRAIN_CHANNEL_1 through \ref
 * TRAIN_CHANNEL_3 and
 * \ref TRAIN_CHANNEL_ALL. The port must be configured as a Lowspeed port before
 * using this function.
 *
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char MSIRTrain(const byte port, const byte i2caddr, const byte channel,
                      const byte func);
 ...
 * PF_CMD_STOP, PF_CMD_REV, PF_CMD_FWD, and \ref PF_CMD_BRAKE. Valid channels
 * are PF_CHANNEL_1 through PF_CHANNEL_4. The port must be configured as a
 * Lowspeed port before using this function.
 *
 * \param port The sensor port. See \ref InPorts.
 * \param i2caddr The sensor I2C address. See sensor documentation for this
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char MSPFComboDirect(const byte port, const byte i2caddr,
                            const byte channel, const byte outa,
                            const byte outb);
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char MSPFComboPWM(const byte port, const byte i2caddr,
                         const byte channel, const byte outa, const byte outb);
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char MSPFRawOutput(const byte port, const byte i2caddr,
                          const byte nibble0, const byte nibble1,
                          const byte nibble2);
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char MSPFRepeat(const byte port, const byte i2caddr, const byte count,
                       const unsigned int delay);
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char MSPFSingleOutputCST(const byte port, const byte i2caddr,
                                const byte channel, const byte out,
                                const byte func);
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char MSPFSingleOutputPWM(const byte port, const byte i2caddr,
                                const byte channel, const byte out,
                                const byte func);
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char MSPFSinglePin(const byte port, const byte i2caddr,
                          const byte channel, const byte out, const byte pin,
                          const byte func, bool cont);
 ...
 * \return The function call result. \ref NO_ERR or \ref CommandCommErrors.
 */
inline char MSPFTrain(const byte port, const byte i2caddr, const byte channel,
                      const byte func);
 ...
 * \param value The RCX value.
 */
inline void MSRCXAbsVar(const byte varnum, const byte byte src,
                        const unsigned int value);
 ...
 * \param value The RCX value.
 */
inline void MSRCXAndVar(const byte varnum, const byte src,
                        const unsigned int value);
 ...
 */
inline void MSRCXCalibrateEvent(const byte evt, const byte low, const byte hi,
                                const byte hyst);
 ...
 * \param value The RCX value.
 */
inline void MSRCXDivVar(const byte varnum, const byte src,
                        const unsigned int value);
 ...
 * \param value The RCX value.
 */
inline void MSRCXOrVar(const byte varnum, const byte src,
                       const unsigned int value);
 ...
 * \param value The RCX value.
 */
inline void MSRCXSet(const byte dstsrc, const byte dstval, const byte src,
                     unsigned int value);
 ...
 * \param pwrval The RCX value.
 */
inline void MSRCXSetMaxPower(const byte outputs, const byte pwrsrc,
                             const byte pwrval);
 ...
 * \param pwrval The RCX value.
 */
inline void MSRCXSetPower(const byte outputs, const byte pwrsrc,
                          const byte pwrval);
 ...
 */
inline void MSRCXSetUserDisplay(const byte src, const unsigned int value,
 ...
 * \param value The RCX value.
 */
inline void MSRCXSetVar(const byte varnum, const byte src,
                        const unsigned int value);
 ...
 * \param value The RCX value.
 */
inline void MSRCXSgnVar(const byte varnum, const byte src,
                        const unsigned int value);
 ...
 * \param value The RCX value.
 */
inline void MSRCXSubVar(const byte varnum, const byte src,
                        const unsigned int value);
 ...
 * \param value The RCX value.
 */
inline void MSRCXSumVar(const byte varnum, const byte src,
                        const unsigned int value);
 ...
 * \param value The Scout value.
 */
inline void MSScoutSetCounterLimit(const byte ctr, const byte src,
                                   const unsigned int value);
 ...
 */
inline void MSScoutSetScoutRules(const byte m, const byte t, const byte l,
                                 const byte tm, const byte fx);
 ...
 * \param value The Scout value.
 */
inline void MSScoutSetSensorHysteresis(const byte src,
                                       const unsigned int value);
 ...
 * \param value The Scout value.
 */
inline void MSScoutSetSensorLowerLimit(const byte src,
                                       const unsigned int value);
 ...
 * \param value The Scout value.
 */
inline void MSScoutSetSensorUpperLimit(const byte src,
                                       const unsigned int value);
 ...
 * \param value The Scout value.
 */
inline void MSScoutSetTimerLimit(const byte tmr, const byte src,
                                 const unsigned int value);
...
#define SensorMSCompass(_port, _i2caddr)                                       \
  asm { ReadSensorMSCompass(_port, _i2caddr, __RETVAL__) }
#define ReadSensorMSRTClock(_port, _sec, _min, _hrs, _dow, _date, _month,      \
                            _year)                                             \
  asm { __ReadSensorMSRTClock(_port, _sec, _min, _hrs, _dow, _date, _month, _year, __RETVAL__) }
#define ReadSensorMSTilt(_port, _i2caddr, _x, _y, _z)                          \
  asm { __ReadSensorMSTilt(_port, _i2caddr, _x, _y, _z, __RETVAL__) }
#define ReadSensorMSAccel(_port, _i2caddr, _x, _y, _z)                         \
  asm { __ReadSensorMSAccel(_port, _i2caddr, _x, _y, _z, __RETVAL__) }

#define MSReadValue(_port, _i2caddr, _reg, _bytes)                             \
  asm { __MSReadValue(_port, _i2caddr, _reg, _bytes, __RETVAL__, __TMPBYTE__) }
#define MSEnergize(_port, _i2caddr)                                            \
  asm { __I2CSendCmd(_port, _i2caddr, MS_CMD_ENERGIZED, __RETVAL__) }
#define MSDeenergize(_port, _i2caddr)                                          \
  asm { __I2CSendCmd(_port, _i2caddr, MS_CMD_DEENERGIZED, __RETVAL__) }
#define MSADPAOn(_port, _i2caddr)                                              \
  asm { __I2CSendCmd(_port, _i2caddr, MS_CMD_ADPA_ON, __RETVAL__) }
#define MSADPAOff(_port, _i2caddr)                                             \
  asm { __I2CSendCmd(_port, _i2caddr, MS_CMD_ADPA_OFF, __RETVAL__) }

#define DISTNxGP2D12(_port, _i2caddr)                                          \
  asm { __I2CSendCmd(_port, _i2caddr, DIST_CMD_GP2D12, __RETVAL__) }
#define DISTNxGP2D120(_port, _i2caddr)                                         \
  asm { __I2CSendCmd(_port, _i2caddr, DIST_CMD_GP2D120, __RETVAL__) }
#define DISTNxGP2YA21(_port, _i2caddr)                                         \
  asm { __I2CSendCmd(_port, _i2caddr, DIST_CMD_GP2YA21, __RETVAL__) }
#define DISTNxGP2YA02(_port, _i2caddr)                                         \
  asm { __I2CSendCmd(_port, _i2caddr, DIST_CMD_GP2YA02, __RETVAL__) }
#define DISTNxDistance(_port, _i2caddr)                                        \
  asm { __MSReadValue(_port, _i2caddr, DIST_REG_DIST, 2, __RETVAL__, __TMPBYTE__) }
#define DISTNxVoltage(_port, _i2caddr)                                         \
  asm { __MSReadValue(_port, _i2caddr, DIST_REG_VOLT, 2, __RETVAL__, __TMPBYTE__) }
#define DISTNxModuleType(_port, _i2caddr)                                      \
  asm { __MSReadValue(_port, _i2caddr, DIST_REG_MODULE_TYPE, 1, __RETVAL__, __TMPBYTE__) }
#define DISTNxNumPoints(_port, _i2caddr)                                       \
  asm { __MSReadValue(_port, _i2caddr, DIST_REG_NUM_POINTS, 1, __RETVAL__, __TMPBYTE__) }
#define DISTNxMinDistance(_port, _i2caddr)                                     \
  asm { __MSReadValue(_port, _i2caddr, DIST_REG_DIST_MIN, 2, __RETVAL__, __TMPBYTE__) }
#define DISTNxMaxDistance(_port, _i2caddr)                                     \
  asm { __MSReadValue(_port, _i2caddr, DIST_REG_DIST_MAX, 2, __RETVAL__, __TMPBYTE__) }

#define ACCLNxCalibrateX(_port, _i2caddr)                                      \
  asm { __I2CSendCmd(_port, _i2caddr, ACCL_CMD_X_CAL, __RETVAL__) }
#define ACCLNxCalibrateXEnd(_port, _i2caddr)                                   \
  asm { __I2CSendCmd(_port, _i2caddr, ACCL_CMD_X_CAL_END, __RETVAL__) }
#define ACCLNxCalibrateY(_port, _i2caddr)                                      \
  asm { __I2CSendCmd(_port, _i2caddr, ACCL_CMD_Y_CAL, __RETVAL__) }
#define ACCLNxCalibrateYEnd(_port, _i2caddr)                                   \
  asm { __I2CSendCmd(_port, _i2caddr, ACCL_CMD_Y_CAL_END, __RETVAL__) }
#define ACCLNxCalibrateZ(_port, _i2caddr)                                      \
  asm { __I2CSendCmd(_port, _i2caddr, ACCL_CMD_Z_CAL, __RETVAL__) }
#define ACCLNxCalibrateZEnd(_port, _i2caddr)                                   \
  asm { __I2CSendCmd(_port, _i2caddr, ACCL_CMD_Z_CAL_END, __RETVAL__) }
#define ACCLNxResetCalibration(_port, _i2caddr)                                \
  asm { __I2CSendCmd(_port, _i2caddr, ACCL_CMD_RESET_CAL, __RETVAL__) }
#define SetACCLNxSensitivity(_port, _i2caddr, _slevel)                         \
  asm { __I2CSendCmd(_port, _i2caddr, _slevel, __RETVAL__) }
#define ACCLNxSensitivity(_port, _i2caddr)                                     \
  asm { __MSReadValue(_port, _i2caddr, ACCL_REG_sENS_LVL, 1, __RETVAL__, __TMPBYTE__) }
#define ACCLNxXOffset(_port, _i2caddr)                                         \
  asm { __MSReadValue(_port, _i2caddr, ACCL_REG_X_OFFSET, 2, __RETVAL__, __TMPBYTE__) }
#define ACCLNxXRange(_port, _i2caddr)                                          \
  asm { __MSReadValue(_port, _i2caddr, ACCL_REG_X_RANGE, 2, __RETVAL__, __TMPBYTE__) }
#define ACCLNxYOffset(_port, _i2caddr)                                         \
  asm { __MSReadValue(_port, _i2caddr, ACCL_REG_Y_OFFSET, 2, __RETVAL__, __TMPBYTE__) }
#define ACCLNxYRange(_port, _i2caddr)                                          \
  asm { __MSReadValue(_port, _i2caddr, ACCL_REG_Y_RANGE, 2, __RETVAL__, __TMPBYTE__) }
#define ACCLNxZOffset(_port, _i2caddr)                                         \
  asm { __MSReadValue(_port, _i2caddr, ACCL_REG_Z_OFFSET, 2, __RETVAL__, __TMPBYTE__) }
#define ACCLNxZRange(_port, _i2caddr)                                          \
  asm { __MSReadValue(_port, _i2caddr, ACCL_REG_Z_RANGE, 2, __RETVAL__, __TMPBYTE__) }

#define PFMateSend(_port, _i2caddr, _channel, _motors, _cmdA, _spdA, _cmdB,    \
                   _spdB)                                                      \
  asm { __PFMateSend(_port, _i2caddr, _channel, _motors, _cmdA, _spdA, _cmdB, _spdB, __RETVAL__) }
#define PFMateSendRaw(_port, _i2caddr, _channel, _b1, _b2)                     \
  asm { __PFMateSendRaw(_port, _i2caddr, _channel, _b1, _b2, __RETVAL__) }

#define NXTServoPosition(_port, _i2caddr, _servo)                              \
  asm { __MSReadValue(_port, _i2caddr, NXTSERVO_REG_S1_POS+(_servo*2), 2, __RETVAL__, __TMPBYTE__) }
#define NXTServoSpeed(_port, _i2caddr, _servo)                                 \
  asm { __MSReadValue(_port, _i2caddr, NXTSERVO_REG_S1_SPEED+_servo, 1, __RETVAL__, __TMPBYTE__) }
#define NXTServoBatteryVoltage(_port, _i2caddr)                                \
  asm { __MSReadValue(_port, _i2caddr, NXTSERVO_REG_VOLTAGE, 1, __RETVAL__, __TMPBYTE__) }
#define SetNXTServoSpeed(_port, _i2caddr, _servo, _speed)                      \
  asm { __MSWriteToRegister(_port, _i2caddr, NXTSERVO_REG_S1_SPEED+_servo, _speed, __RETVAL__) }
#define SetNXTServoQuickPosition(_port, _i2caddr, _servo, _qpos)               \
  asm { __MSWriteToRegister(_port, _i2caddr, NXTSERVO_REG_S1_QPOS+_servo, _qpos, __RETVAL__) }
#define SetNXTServoPosition(_port, _i2caddr, _servo, _pos)                     \
  asm { __MSWriteLEIntToRegister(_port, _i2caddr, NXTSERVO_REG_S1_POS+(_servo*2), _pos, __RETVAL__) }
#define NXTServoReset(_port, _i2caddr)                                         \
  asm { __I2CSendCmd(_port, _i2caddr, NXTSERVO_CMD_RESET, __RETVAL__) }
#define NXTServoHaltMacro(_port, _i2caddr)                                     \
  asm { __I2CSendCmd(_port, _i2caddr, NXTSERVO_CMD_HALT, __RETVAL__) }
#define NXTServoResumeMacro(_port, _i2caddr)                                   \
  asm { __I2CSendCmd(_port, _i2caddr, NXTSERVO_CMD_RESUME, __RETVAL__) }
#define NXTServoPauseMacro(_port, _i2caddr)                                    \
  asm { __I2CSendCmd(_port, _i2caddr, NXTSERVO_CMD_PAUSE, __RETVAL__) }
#define NXTServoInit(_port, _i2caddr, _servo)                                  \
  asm { __NXTServoInit(_port, _i2caddr, _servo, __RETVAL__) }
#define NXTServoGotoMacroAddress(_port, _i2caddr, _macro)                      \
  asm { __NXTServoGotoMacroAddress(_port, _i2caddr, _macro, __RETVAL__) }
#define NXTServoEditMacro(_port, _i2caddr)                                     \
  asm { __NXTServoEditMacro(_port, _i2caddr, __RETVAL__) }
#define NXTServoQuitEdit(_port)                                                \
  asm { __MSWriteToRegister(_port, MS_ADDR_NXTSERVO_EM, NXTSERVO_EM_REG_CMD, NXTSERVO_EM_CMD_QUIT, __RETVAL__) }

#define NXTHIDAsciiMode(_port, _i2caddr)                                       \
  asm { __I2CSendCmd(_port, _i2caddr, NXTHID_CMD_ASCII, __RETVAL__) }
#define NXTHIDDirectMode(_port, _i2caddr)                                      \
  asm { __I2CSendCmd(_port, _i2caddr, NXTHID_CMD_DIRECT, __RETVAL__) }
#define NXTHIDTransmit(_port, _i2caddr)                                        \
  asm { __I2CSendCmd(_port, _i2caddr, NXTHID_CMD_TRANSMIT, __RETVAL__) }
#define NXTHIDLoadCharacter(_port, _i2caddr, _modifier, _character)            \
  asm { __NXTHIDLoadCharacter(_port, _i2caddr, _modifier, _character, __RETVAL__) }

#define NXTPowerMeterResetCounters(_port, _i2caddr)                            \
  asm { __I2CSendCmd(_port, _i2caddr, NXTPM_CMD_RESET, __RETVAL__) }
#define NXTPowerMeterPresentCurrent(_port, _i2caddr)                           \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_CURRENT, 2, __RETVAL__, __TMPBYTE__) }
#define NXTPowerMeterPresentVoltage(_port, _i2caddr)                           \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_VOLTAGE, 2, __RETVAL__, __TMPBYTE__) }
#define NXTPowerMeterCapacityUsed(_port, _i2caddr)                             \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_CAPACITY, 2, __RETVAL__, __TMPBYTE__) }
#define NXTPowerMeterPresentPower(_port, _i2caddr)                             \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_POWER, 2, __RETVAL__, __TMPBYTE__) }
#define NXTPowerMeterTotalPowerConsumed(_port, _i2caddr)                       \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_POWER, 4, __RETVAL__, __TMPBYTE__) }
#define NXTPowerMeterMaxCurrent(_port, _i2caddr)                               \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_MAXCURRENT, 2, __RETVAL__, __TMPBYTE__) }
#define NXTPowerMeterMinCurrent(_port, _i2caddr)                               \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_MINCURRENT, 2, __RETVAL__, __TMPBYTE__) }
#define NXTPowerMeterMaxVoltage(_port, _i2caddr)                               \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_MAXVOLTAGE, 2, __RETVAL__, __TMPBYTE__) }
#define NXTPowerMeterMinVoltage(_port, _i2caddr)                               \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_MINVOLTAGE, 2, __RETVAL__, __TMPBYTE__) }
#define NXTPowerMeterElapsedTime(_port, _i2caddr)                              \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_TIME, 4, __RETVAL__, __TMPBYTE__) }
#define NXTPowerMeterErrorCount(_port, _i2caddr)                               \
  asm { __MSReadValue(_port, _i2caddr, NXTPM_REG_ERRORCOUNT, 2, __RETVAL__, __TMPBYTE__) }

#define NXTLineLeaderSteering(_port, _i2caddr)                                 \
  asm { __MSReadValue(_port, _i2caddr, NXTLL_REG_STEERING, 1, __RETVAL__, __TMPBYTE__) }
#define NXTLineLeaderAverage(_port, _i2caddr)                                  \
  asm { __MSReadValue(_port, _i2caddr, NXTLL_REG_AVERAGE, 1, __RETVAL__, __TMPBYTE__) }
#define NXTLineLeaderResult(_port, _i2caddr)                                   \
  asm { __MSReadValue(_port, _i2caddr, NXTLL_REG_RESULT, 1, __RETVAL__, __TMPBYTE__) }
#define NXTLineLeaderPowerDown(_port, _i2caddr)                                \
  asm { __I2CSendCmd(_port, _i2caddr, NXTLL_CMD_POWERDOWN, __RETVAL__) }
#define NXTLineLeaderPowerUp(_port, _i2caddr)                                  \
  asm { __I2CSendCmd(_port, _i2caddr, NXTLL_CMD_POWERUP, __RETVAL__) }
#define NXTLineLeaderInvert(_port, _i2caddr)                                   \
  asm { __I2CSendCmd(_port, _i2caddr, NXTLL_CMD_INVERT, __RETVAL__) }
#define NXTLineLeaderReset(_port, _i2caddr)                                    \
  asm { __I2CSendCmd(_port, _i2caddr, NXTLL_CMD_RESET, __RETVAL__) }
#define NXTLineLeaderSnapshot(_port, _i2caddr)                                 \
  asm { __I2CSendCmd(_port, _i2caddr, NXTLL_CMD_SNAPSHOT, __RETVAL__) }
#define NXTLineLeaderCalibrateWhite(_port, _i2caddr)                           \
  asm { __I2CSendCmd(_port, _i2caddr, NXTLL_CMD_WHITE, __RETVAL__) }
#define NXTLineLeaderCalibrateBlack(_port, _i2caddr)                           \
  asm { __I2CSendCmd(_port, _i2caddr, NXTLL_CMD_BLACK, __RETVAL__) }
#define SetNXTLineLeaderSetpoint(_port, _i2caddr, _value)                      \
  asm { __MSWriteToRegister(_port, _i2caddr, NXTLL_REG_SETPOINT, _value, __RETVAL__) }
#define SetNXTLineLeaderKpValue(_port, _i2caddr, _value)                       \
  asm { __MSWriteToRegister(_port, _i2caddr, NXTLL_REG_KP_VALUE, _value, __RETVAL__) }
#define SetNXTLineLeaderKiValue(_port, _i2caddr, _value)                       \
  asm { __MSWriteToRegister(_port, _i2caddr, NXTLL_REG_KI_VALUE, _value, __RETVAL__) }
#define SetNXTLineLeaderKdValue(_port, _i2caddr, _value)                       \
  asm { __MSWriteToRegister(_port, _i2caddr, NXTLL_REG_KD_VALUE, _value, __RETVAL__) }
#define SetNXTLineLeaderKpFactor(_port, _i2caddr, _value)                      \
  asm { __MSWriteToRegister(_port, _i2caddr, NXTLL_REG_KP_FACTOR, _value, __RETVAL__) }
#define SetNXTLineLeaderKiFactor(_port, _i2caddr, _value)                      \
  asm { __MSWriteToRegister(_port, _i2caddr, NXTLL_REG_KI_FACTOR, _value, __RETVAL__) }
#define SetNXTLineLeaderKdFactor(_port, _i2caddr, _value)                      \
  asm { __MSWriteToRegister(_port, _i2caddr, NXTLL_REG_KD_FACTOR, _value, __RETVAL__) }

#define PSPNxDigital(_port, _i2caddr)                                          \
  asm { __I2CSendCmd(_port, _i2caddr, PSP_CMD_DIGITAL, __RETVAL__) }
#define PSPNxAnalog(_port, _i2caddr)                                           \
  asm { __I2CSendCmd(_port, _i2caddr, PSP_CMD_ANALOG, __RETVAL__) }

#define ReadSensorMSPlayStation(_port, _i2caddr, _b1, _b2, _xleft, _yleft,     \
                                _xright, _yright)                              \
  asm { __ReadSensorMSPlayStation(_port, _i2caddr, _b1, _b2, _xleft, _yleft, _xright, _yright, __RETVAL__) }

#define NRLink2400(_port, _i2caddr)                                            \
  asm { __I2CSendCmd(_port, _i2caddr, NRLINK_CMD_2400, __RETVAL__) }
#define NRLink4800(_port, _i2caddr)                                            \
  asm { __I2CSendCmd(_port, _i2caddr, NRLINK_CMD_4800, __RETVAL__) }
#define NRLinkFlush(_port, _i2caddr)                                           \
  asm { __I2CSendCmd(_port, _i2caddr, NRLINK_CMD_FLUSH, __RETVAL__) }
#define NRLinkIRLong(_port, _i2caddr)                                          \
  asm { __I2CSendCmd(_port, _i2caddr, NRLINK_CMD_IR_LONG, __RETVAL__) }
#define NRLinkIRShort(_port, _i2caddr)                                         \
  asm { __I2CSendCmd(_port, _i2caddr, NRLINK_CMD_IR_SHORT, __RETVAL__) }
#define NRLinkTxRaw(_port, _i2caddr)                                           \
  asm { __I2CSendCmd(_port, _i2caddr, NRLINK_CMD_TX_RAW, __RETVAL__) }
#define NRLinkSetRCX(_port, _i2caddr)                                          \
  asm { __I2CSendCmd(_port, _i2caddr, NRLINK_CMD_SET_RCX, __RETVAL__) }
#define NRLinkSetTrain(_port, _i2caddr)                                        \
  asm { __I2CSendCmd(_port, _i2caddr, NRLINK_CMD_SET_TRAIN, __RETVAL__) }
#define NRLinkSetPF(_port, _i2caddr)                                           \
  asm { __I2CSendCmd(_port, _i2caddr, NRLINK_CMD_SET_PF, __RETVAL__) }

#define RunNRLinkMacro(_port, _i2caddr, _macro)                                \
  asm { __RunNRLinkMacro(_port, _i2caddr, _macro, __RETVAL__) }

#define NRLinkStatus(_port, _i2caddr)                                          \
  asm { ReadNRLinkStatus(_port, _i2caddr, __RETVAL__, __TMPBYTE__) }

#define WriteNRLinkBytes(_port, _i2caddr, _bytes)                              \
  asm { __WriteNRLinkBytes(_port, _i2caddr, _bytes, __RETVAL__) }
#define ReadNRLinkBytes(_port, _i2caddr, _bytes)                               \
  asm { __ReadNRLinkBytes(_port, _i2caddr, _bytes, __RETVAL__) }

#define MSPFComboDirect(_port, _i2caddr, _channel, _outa, _outb)               \
  asm { __MSPFComboDirect(_port, _i2caddr, _channel, _outa, _outb, __RETVAL__) }
#define MSPFSinglePin(_port, _i2caddr, _channel, _out, _pin, _func, _cont)     \
  asm { __MSPFSinglePin(_port, _i2caddr, _channel, _out, _pin, _func, _cont, __RETVAL__) }
#define MSPFSingleOutputCST(_port, _i2caddr, _channel, _out, _func)            \
  asm { __MSPFSingleOutput(_port, _i2caddr, _channel, _out, _func, TRUE, __RETVAL__) }
#define MSPFSingleOutputPWM(_port, _i2caddr, _channel, _out, _func)            \
  asm { __MSPFSingleOutput(_port, _i2caddr, _channel, _out, _func, FALSE, __RETVAL__) }
#define MSPFComboPWM(_port, _i2caddr, _channel, _outa, _outb)                  \
  asm { __MSPFComboPWM(_port, _i2caddr, _channel, _outa, _outb, __RETVAL__) }
#define MSPFTrain(_port, _i2caddr, _channel, _func)                            \
  asm { __MSIRTrain(_port, _i2caddr, _channel, _func, TRUE, __RETVAL__) }
#define MSIRTrain(_port, _i2caddr, _channel, _func)                            \
  asm { __MSIRTrain(_port, _i2caddr, _channel, _func, FALSE, __RETVAL__) }
#define MSPFRawOutput(_port, _i2caddr, _nibble0, _nibble1, _nibble2)           \
  asm { __MSPFRawOutput(_port, _i2caddr, _nibble0, _nibble1, _nibble2, __RETVAL__) }
#define MSPFRepeat(_port, _i2caddr, _count, _delay)                            \
  asm { __MSPFRepeatLastCommand(_port, _i2caddr, _count, _delay, __RETVAL__) }

#define MSRCXSetNRLinkPort(_port, _i2caddr)                                    \
  asm { __MSRCXSetNRLink(_port, _i2caddr) }
...
#define MSRCXSetDirection(_outputs, _dir)                                      \
  asm { __MSRCXSetDirection(_outputs, _dir) }
#define MSRCXSetPower(_outputs, _pwrsrc, _pwrval)                              \
  asm { __MSRCXSetPower(_outputs, _pwrsrc, _pwrval) }
...
#define MSRCXToggle(_outputs)                                                  \
  asm { __MSRCXSetDirection(_outputs, RCX_OUT_TOGGLE) }
...
#define MSRCXPlayToneVar(_varnum, _duration)                                   \
  asm { __MSRCXPlayToneVar(_varnum, _duration) }
#define MSRCXSetWatch(_hours, _minutes) asm { __MSRCXSetWatch(_hours, _minutes) }
#define MSRCXSetSensorType(_port, _type)                                       \
  asm { __MSRCXSetSensorType(_port, _type) }
#define MSRCXSetSensorMode(_port, _mode)                                       \
  asm { __MSRCXSetSensorMode(_port, _mode) }
...
#define MSRCXSelectDisplay(_src, _value)                                       \
  asm { __MSRCXSelectDisplay(_src, _value) }
#define MSRCXPollMemory(_memaddress)                                           \
  asm { __MSRCXPollMemory(_memaddress, __RETVAL__) }
#define MSRCXSetEvent(_evt, _src, _type) asm { __MSRCXSetEvent(_evt, _src, _type) }
#define MSRCXSetGlobalOutput(_outputs, _mode)                                  \
  asm { __MSRCXSetGlobalOutput(_outputs, _mode) }
#define MSRCXSetGlobalDirection(_outputs, _dir)                                \
  asm { __MSRCXSetGlobalDirection(_outputs, _dir) }
#define MSRCXSetMaxPower(_outputs, _pwrsrc, _pwrval)                           \
  asm { __MSRCXSetMaxPower(_outputs, _pwrsrc, _pwrval) }
#define MSRCXEnableOutput(_outputs)                                            \
  asm { __MSRCXSetGlobalOutput(_outputs, RCX_OUT_ON) }
#define MSRCXDisableOutput(_outputs)                                           \
  asm { __MSRCXSetGlobalOutput(_outputs, RCX_OUT_OFF) }
#define MSRCXInvertOutput(_outputs)                                            \
  asm { __MSRCXSetGlobalDirection(_outputs, RCX_OUT_REV) }
#define MSRCXObvertOutput(_outputs)                                            \
  asm { __MSRCXSetGlobalDirection(_outputs, RCX_OUT_FWD) }
#define MSRCXCalibrateEvent(_evt, _low, _hi, _hyst)                            \
  asm { __MSRCXCalibrateEvent(_evt, _low, _hi, _hyst) }
#define MSRCXSetVar(_varnum, _src, _value)                                     \
...
#define MSRCXDivVar(_varnum, _src, _value)                                     \
  asm { __MSRCXVarOp(RCX_DivVarOp, _varnum, _src, _value) }
...
#define MSRCXSetUserDisplay(_src, _value, _precision)                          \
  asm { __MSRCXSetUserDisplay(_src, _value, _precision) }
...
#define MSScoutSetCounterLimit(_ctr, _src, _value)                             \
  asm { __MSScoutSetCounterLimit(_ctr, _src, _value) }
#define MSScoutSetTimerLimit(_tmr, _src, _value)                               \
...
#define MSScoutSetSensorUpperLimit(_src, _value)                               \
...
#define MSScoutSetScoutRules(_m, _t, _l, _tm, _fx)                             \
  asm { __MSScoutSetScoutRules(_m, _t, _l, _tm, _fx) }
...
#define RFIDReadSingle(_port, _output)                                         \
  asm { __RFIDReadSingle(_port, _output, __RETVAL__) }
#define RFIDReadContinuous(_port, _output)                                     \
  asm { __RFIDReadContinuous(_port, _output, __RETVAL__) }
...
inline float pow(float base, float exponent) {
  asm { pow __FLTRETVAL__, base, exponent }
}
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline float atan2d(float y, float x) {
  asm { atan2d __FLTRETVAL__, y, x }
}
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline float coshd(float x) {
  asm { coshd __FLTRETVAL__, x }
}
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline float sinhd(float x) {
  asm { sinhd __FLTRETVAL__, x }
}
 ...
 * \warning This function requires the enhanced NBC/NXC firmware.
 */
inline float tanhd(float x) {
  asm { tanhd __FLTRETVAL__, x }
}
...
// X is any integer; Y is the sqrt value (0->max); if X<0, Y is the sqrt value
// of absolute X
...
// X is 100* the sin value (-100->100); Y is -90->90; Y is 101 if X is outside
// -100->100 range
#define Asin(_X) asm { __ASIN(_X,__RETVAL__) }

// X is 100* the cos value (-100->100); Y is 0->180; Y is -11 if X is outside
// -100->100 range
 ...
 */
inline void set_fopen_size(unsigned long fsize) {
  __fopen_default_size = fsize;
}
 ...
 * \return A value of zero if successful or non-zero otherwise. See \ref
 * LoaderErrors.
 *
 * \warning This function requires the enhanced NBC/NXC firmware version 1.28+.
 */
...
/*
  size_t fread(ptr, size, count, FILE*); // read blocks of data from file;
  returns number of blocks read size_t fwrite(ptr, size, count, FILE*); // write
  blocks of data to stream; returns number of blocks written int putchar(int
  character); // write character to stdout
*/
 ...
 * number of the specified base, which is returned as an unsigned long int
 * value.
 *
 * The function first discards as many whitespace characters as necessary
 * until the first non-whitespace character is found. Then, starting from this
 ...
 * conversion is performed.
 *
 * \param str String containing the representation of an unsigned integral
 * number.
 * \param endptr Reference to a string, whose value is set by the function to
 * the remaining characters in str after the numerical value.
 * \param base Optional and ignored if specified.
...
#define UnflattenVar(_str, _value)                                             \
  asm { \
 ...
 * not found.
 */
inline int Pos(string Substr, string S) {
  asm { __doPos(Substr, S, __RETVAL__) }
}
...
inline string ByteArrayToStr(byte data[]) {
  asm { arrtostr __STRBUFFER__, data }
}
 ...
 * \return The substring of a specified length that appears at the end of a
 * string.
 */
 ...
 * \param str A string
 * \param size The size or length of the substring.
 * \return The substring of a specified length that appears at the start of a
 * string.
 */
...
/*
void * memchr (void * ptr, int value, size_t num ); // Locate character in block
of memory char * strchr (       char * str, int character ); // Locate first
occurrence of character in string size_t strcspn ( const char * str1, const char
* str2 ); // Get span until character in string char * strpbrk ( const char *,
const char * ); // Locate character in string char * strrchr ( const char *, int
); // Locate last occurrence of character in string size_t strspn ( const char *
str1, const char * str2 ); // Get span of character set in string char * strtok
( char * str, const char * delimiters ); // Split string into tokens char *
strstr ( const char *, const char * ); // Locate substring

void * memset ( void * ptr, byte value, size_t num ); // Fill block of memory
 ...
 */
#define RICSetValue(_data, _idx, _newval)                                      \
  _data[(_idx)] = (_newval) & 0xFF;                                            \
 ...
 * \param glValue The setting value. For culling modes see \ref
 * GLConstantsCullMode.
 */
inline void glSet(int glType, int glValue) {
  asm { __glSet(glType, glValue) }
}
 ...
 */
inline int glBeginObject() {
  asm { __glBeginObject(__RETVAL__) }
}
 ...
 * \param glAction The action to perform on the object. See \ref
 * GLConstantsActions.
 ...
 */
inline void glBegin(int glBeginMode) {
  asm { __glBegin(glBeginMode) }
}
 ...
 */
inline void glCallObject(int glObjectId) {
  asm { __glCallObject(glObjectId) }
}
 ...
 * to the LCD.
 */
inline void glFinishRender() {
  asm { __glFinishRender() }
}
 ...
 */
inline void glSetAngleX(int glValue) {
  asm { __glSetAngleX(glValue) }
}
 ...
 */
inline void glAddToAngleX(int glValue) {
  asm { __glAddToAngleX(glValue) }
}
 ...
 */
inline void glSetAngleY(int glValue) {
  asm { __glSetAngleY(glValue) }
}
 ...
 */
inline void glAddToAngleY(int glValue) {
  asm { __glAddToAngleY(glValue) }
}
 ...
 */
inline void glSetAngleZ(int glValue) {
  asm { __glSetAngleZ(glValue) }
}
 ...
 */
inline void glAddToAngleZ(int glValue) {
  asm { __glAddToAngleZ(glValue) }
}
 ...
 */
inline int glSin32768(int glAngle) {
  asm { __glSin32768(__RETVAL__, glAngle) }
}
 ...
 */
inline int glCos32768(int glAngle) {
  asm { __glCos32768(__RETVAL__, glAngle) }
}
 ...
 *
 * \param glMode The begin mode for each surface.  See \ref
 ...
 * of the box is at the origin of the XYZ axis with equal width, height, and
 * depth specified via the glSize parameter.
 *
 * \param glMode The begin mode for each surface.  See \ref
 * GLConstantsBeginModes.
 ...
 * algorithm. See \ref PIDConstants. Default value is \ref PID_1.
 */
inline void PosRegEnable(byte output, byte p = PID_3, byte i = PID_1,
                         byte d = PID_1) {
  SetOutput(output, OutputModeField,
            OUT_MODE_MOTORON + OUT_MODE_BRAKE + OUT_MODE_REGULATED,
            RegModeField, OUT_REGMODE_POS, RunStateField, OUT_RUNSTATE_RUNNING,
            PowerField, 0, TurnRatioField, 0, RegPValueField, p, RegIValueField,
            i, RegDValueField, d, UpdateFlagsField,
            UF_UPDATE_MODE + UF_UPDATE_SPEED + UF_UPDATE_PID_VALUES +
...
inline void PosRegSetAngle(byte output, long angle) {
  SetOutput(output, TachoLimitField, angle, UpdateFlagsField,
...
inline void PosRegAddAngle(byte output, long angle_add) {
  ...
  SetOutput(output, TachoLimitField, current_angle + angle_add,
...
inline void PosRegSetMax(byte output, byte max_speed, byte max_acceleration) {
  SetOutput(output, MaxSpeedField, max_speed, MaxAccelerationField,
            max_acceleration, UpdateFlagsField, UF_UPDATE_PID_VALUES);
  Wait(MS_2);
}
